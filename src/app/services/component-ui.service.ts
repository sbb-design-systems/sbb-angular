  ...
  constructor() {
    this.uiComponents = [
      new UiComponent('Button',
                      ...
                      true,
                      false,
                      ['Davide Aresta', 'Dario D\'Oronzo', 'Stefan Meili'],
                      'Description goes here ...'),
      new UiComponent('List',
                      'list',
                      'List',
      ...
      new UiComponent('Loading Indicator',
                      'loadingIndicator',
                      'Loading Indicator',
                      'Subtitel goes here ...',
                      true,
      ...
      new UiComponent('Autocompletion',
                      'autocompletion',
                      'Autocompletion',
                      'Subtitel goes here ...',
                      true,
      ...
      new UiComponent('SBB Field',
                      'sbbField',
                      'SBB Field',
                      'SBB Field is a wrapper to standard sbb-label, input and sbb-form-error with theming.',
                      true,
                      false,
                      ['Davide Aresta', 'Dario D\'Oronzo', 'Stefan Meili'],
                      'Description goes here ...',
      ...
      new UiComponent('Accordion',
                      ...
                      ['Davide Aresta', 'Dario D\'Oronzo', 'Stefan Meili'],
                      'Description goes here ...'),
      new UiComponent('Section (Fieldset)',
                      'section',
                      'Section (Fieldset)',
                      'Subtitel goes here ...',
                      true,
      ...
      new UiComponent('Process Flow',
                      ...
                      ['Davide Aresta', 'Dario D\'Oronzo', 'Stefan Meili'],
                      'Description goes here ...'),
      new UiComponent('Option Chooser (simple)',
                      'optionChooserSimple',
                      ...
                      ['Davide Aresta', 'Dario D\'Oronzo', 'Stefan Meili'],
                      'Description goes here ...'),
      new UiComponent('Option Chooser (multiple)',
