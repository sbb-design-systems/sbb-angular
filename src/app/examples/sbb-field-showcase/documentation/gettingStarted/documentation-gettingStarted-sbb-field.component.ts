...
@Component({
  selector: 'sbb-field-showcase-documentation-gettingStarted',
  templateUrl: './documentation-gettingStarted-sbb-field.component.html',
  styleUrls: ['./documentation-gettingStarted-sbb-field.component.scss']
})
