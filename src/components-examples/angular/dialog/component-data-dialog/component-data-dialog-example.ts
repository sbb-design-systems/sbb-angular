  ...
  template: `
    ...
    <div sbbDialogContent>
      ...
      <p>
        ...
        your own. and use a wide array of existing.. Get immediate Angular-specific help and
      ...
      <p>
        ...
        app is defined by a set of NgModules. An app always has at least a root module that enables
      ...
      <p>
        ...
        modify according to your program logic and data. Every app has at least a root .
      </p>

      <p>
        Components use services, which provide specific functionality not directly related to views.
        Service providers can be injected into. as dependencies, making your code modular, reusable,
        and efficient.
      </p>
      ...
      <p>
        ...
        to. through Dependency Injection (DI).
      </p>

      <p>
        An app's. typically define many views, arranged hierarchically. Angular provides the Router
        service to help you define navigation paths among views. The router provides sophisticated
        in-browser navigational capabilities. END
      </p>
    </div>
