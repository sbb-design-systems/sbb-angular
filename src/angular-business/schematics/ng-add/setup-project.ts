...
export const TYPOGRAPHY_CSS_PATH = 'node_modules/@sbb-esta/angular-business/typography.css';
export const PUBLIC_TYPOGRAPHY_CSS_PATH = 'node_modules/@sbb-esta/angular-public/typography.css';
...
export default function (options: Schema): Rule {
  return async (host: Tree, context: SchematicContext) => {
    ...
    context.logger.warn(
      '@sbb-esta/angular-business has been set up in your workspace. There is no additional setup ' +
        'required for consuming @sbb-esta/angular-business in your library project.\n\n' +
  ...
  return updateWorkspace((workspace) => {
    ...
    if (!styles) {
      ...
      for (const stylePath of existingStyles) {
        ...
        // In case the public typography is already added, we skip adding the business typography.
        if (stylePath.includes(PUBLIC_TYPOGRAPHY_CSS_PATH)) {
          logger.error(
