  ...
  beforeEach(
    waitForAsync(() => {
      ...
      TestBed.configureTestingModule({
        ...
        declarations: [SbbTabHeader, SbbInkBar, SbbTabLabelWrapper, SimpleTabHeaderApp],
        providers: [
          ViewportRuler,
  ...
  describe('pagination', () => {
    describe('ltr', () => {
      ...
      it('should show ripples for pagination buttons', () => {
        ...
        const buttonAfter = fixture.debugElement.query(By.css('.sbb-tab-header-pagination-after'))!;

        expect(fixture.nativeElement.querySelectorAll('.sbb-ripple-element').length).toBe(
          0,
    ...
    describe('scrolling when holding paginator', () => {
      ...
      function assertNextButtonScrolling(startEventName: string, endEventName: string) {
        ...
        expect(header.scrollDistance).toBeGreaterThan(
          previousDistance,
          'Expected to scroll again after some more time.'
        );
      ...
      function assertPrevButtonScrolling(startEventName: string, endEventName: string) {
        ...
        expect(header.scrollDistance).toBe(
          currentScroll,
          'Expected not to scroll after short amount of time.'
        );

        tick(1000);

        expect(header.scrollDistance).toBeLessThan(
          currentScroll,
          'Expected to scroll after some time.'
        );
