...
LEAFLET_TARGETS = ["//src/angular-leaflet"] + \
                  ["//src/angular-leaflet/%s" % ep for ep in LEAFLET_ENTRYPOINTS]

# List of all testing entry-point targets of the Angular-leaflet package.
LEAFLET_TESTING_TARGETS = ["//src/angular-leaflet/%s" % ep for ep in LEAFLET_TESTING_ENTRYPOINTS]
