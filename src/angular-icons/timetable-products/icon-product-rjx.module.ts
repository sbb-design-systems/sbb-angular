...
export class IconProductRjxComponent extends IconBase {
  constructor() {
...
@NgModule({
  ...
  declarations: [IconProductRjxComponent],
  exports: [IconProductRjxComponent],
})
export class IconProductRjxModule {}
