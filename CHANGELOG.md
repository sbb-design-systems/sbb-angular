...
## [20.0.0](https://github.com/sbb-design-systems/sbb-angular/compare/v1.1.0...v20.0.0) (2025-11-17)


### ⚠ BREAKING CHANGES

* **multiple:** * `SbbDialogConfig.componentFactoryResolver` has been removed
* `SbbLightboxConfig.componentFactoryResolver` has been removed
* **angular/core:** * `mixinErrorState` has been removed.
...
* **angular/lightbox:** * `SBB_LIGHTBOX_SCROLL_STRATEGY_FACTORY` has been removed.
* `SBB_LIGHTBOX_SCROLL_STRATEGY_PROVIDER_FACTORY` has been removed.
* `SBB_LIGHTBOX_SCROLL_STRATEGY_PROVIDER` has been removed.
* **angular/dialog:** * `SBB_DIALOG_SCROLL_STRATEGY_FACTORY` has been removed.
* `SBB_DIALOG_SCROLL_STRATEGY_PROVIDER_FACTORY` has been removed.
* `SBB_DIALOG_SCROLL_STRATEGY_PROVIDER` has been removed.
* **angular/checkbox:** * `SBB_CHECKBOX_REQUIRED_VALIDATOR` has been removed.
* `SBB_CHECKBOX_CONTROL_VALUE_ACCESSOR` has been removed.
* `SbbCheckboxRequiredValidator` has been removed.
* This updates our libraries to Angular 19. Code changes were made by an automatic migration.
* This updates all Angular packages to the newest version. standalone: false was added by the automatic migration. In addition, unused imports are now identified by the builder and were removed manually.
* Update to Angular v18 next, Node >= 18.19.1 and TypeScript 5.4.4. The SbbTable is refactored to work without ngZone which was removed in the Angular CDK.
* **multiple:** This adds the dark mode for the lean design variant. The mode chosen is based on the system settings. To enforce a specific mode, you can add the sbb-light or sbb-dark class to the <html> element.
...
* **angular/button:** sbb-icon-button has been removed and replaced in a way where the icon button styles dynamically get applied if the button only contains an icon. If you have used the sbb-icon-button in standard variant, it now has an increased size from 36px to 48px as the other buttons have.
*  - SbbAnchor: Constructor parameter `ngZone` has become required.
 - SbbDatepicker: Remove unused constructor parameter `document`.
* **journey-maps:** - `minZoomLevel`, `maxZoomLevel` and `maxBounds` have been moved from `viewportOptions` to `viewportBounds` input parameter
...
via an `_index.scss` file in the root of the package. You should now be able use the following code to import our sass code: `@use '@sbb-esta/angular' as sbb;`
...
* **public:** In order to fulfill new requirements, the component internal DOM structure and css class usage has been changed. Please check your code if you have overwritten certain css styles.
...
* This commit changes the css display property of the tooltip trigger
...
* This removes the margin around the public variant of sbbLink and the sbbSocialLink component.
...
* @sbb-esta/angular-core is now a peer dependency of @sbb-esta/angular-public and @sbb-esta/angular-business. This means consumers of this library will need to install @sbb-esta/angular-core manually via `npm install --save @sbb-esta/angular-core`.
...
* This PR removes various deprecated code parts in checkbox, checkbox panel, dropdown, keycloak config, radio button, radio button panel, tag, textarea, toggle, toggle option.

The deprecated highlight pipe has been removed.
...
* Upgrading to version 9 of Angular. As recommended by Angular, the libraries are compiled via ViewEngine, which can be converted to Ivy in an Angular project that is using Ivy (default in Angular 9).
...
* update to Angular 19 (next) ([#2388](https://github.com/sbb-design-systems/sbb-angular/issues/2388)) ([cd8e61c](https://github.com/sbb-design-systems/sbb-angular/commit/cd8e61c3250b4c3eba080dc3feaa92cb7c679432))
...
* update to Angular v18 next ([#2232](https://github.com/sbb-design-systems/sbb-angular/issues/2232)) ([dc43776](https://github.com/sbb-design-systems/sbb-angular/commit/dc43776c462fe7a9d18f07ab1d3c231fe0fd55fb))
* update to latest Angular next version ([#2405](https://github.com/sbb-design-systems/sbb-angular/issues/2405)) ([fbce1d5](https://github.com/sbb-design-systems/sbb-angular/commit/fbce1d56324b55fe8dcff13362e273777d6732ed))
...
* move and refactor sass files ([#28](https://github.com/sbb-design-systems/sbb-angular/issues/28)) ([f2ac62d](https://github.com/sbb-design-systems/sbb-angular/commit/f2ac62d7819c8ef0f507546f83d2405807465083))
* remove deprecated `angular-maps` ([#1897](https://github.com/sbb-design-systems/sbb-angular/issues/1897)) ([1ec457c](https://github.com/sbb-design-systems/sbb-angular/commit/1ec457c0cb16d921c3e00b0c8f21a16d93bab277))
...
* add @sbb-esta/angular-maps ([#264](https://github.com/sbb-design-systems/sbb-angular/issues/264)) ([749d1e5](https://github.com/sbb-design-systems/sbb-angular/commit/749d1e52f7b7db5b375ad9bcb98e93eeb93df1cf))
...
* **angular-icons:** update icons ([#6](https://github.com/sbb-design-systems/sbb-angular/issues/6)) ([a579e74](https://github.com/sbb-design-systems/sbb-angular/commit/a579e749b57cdb4d94b769a4a612de32d7ebb957))
* **angular-keycloak:** migrates the auth part of esta-webjs-extensions ([#50](https://github.com/sbb-design-systems/sbb-angular/issues/50)) ([f6761c5](https://github.com/sbb-design-systems/sbb-angular/commit/f6761c55ac4992e2c009497eecee133186e90128))
...
* **angular/checkbox:** add new aria properties to SbbCheckbox ([#2383](https://github.com/sbb-design-systems/sbb-angular/issues/2383)) ([ae20b68](https://github.com/sbb-design-systems/sbb-angular/commit/ae20b6835372812ff6cff5e58d1681082d1d79aa))
...
* **angular/sidebar:** allow controlling the opened state of the sidebar ([#2367](https://github.com/sbb-design-systems/sbb-angular/issues/2367)) ([7b5536b](https://github.com/sbb-design-systems/sbb-angular/commit/7b5536b76a2842db5346a49cbad8c76cc43fbdc7)), closes [#2360](https://github.com/sbb-design-systems/sbb-angular/issues/2360)
* **angular/sidebar:** allow positioning on the right side of the screen ([#2197](https://github.com/sbb-design-systems/sbb-angular/issues/2197)) ([99ea38f](https://github.com/sbb-design-systems/sbb-angular/commit/99ea38f049daea1e007c949cdbb1d40808995218)), closes [#2130](https://github.com/sbb-design-systems/sbb-angular/issues/2130)
* **angular/sidebar:** make sidebar collapsible ([#2265](https://github.com/sbb-design-systems/sbb-angular/issues/2265)) ([9f78fac](https://github.com/sbb-design-systems/sbb-angular/commit/9f78fac3e3888552ce153238036f1c9c5eb62517)), closes [#2263](https://github.com/sbb-design-systems/sbb-angular/issues/2263)
...
* **angular/tag:** display icons inside tags ([#2192](https://github.com/sbb-design-systems/sbb-angular/issues/2192)) ([2e15df8](https://github.com/sbb-design-systems/sbb-angular/commit/2e15df871698a6e75824a81bd3242274eb88122e)), closes [#2072](https://github.com/sbb-design-systems/sbb-angular/issues/2072)
...
* **angular/tooltip:** allow specifying the preferred position ([#2228](https://github.com/sbb-design-systems/sbb-angular/issues/2228)) ([216ec6e](https://github.com/sbb-design-systems/sbb-angular/commit/216ec6e58ce6d21ecc7e8500c2ebd9ff0332d39b)), closes [#889](https://github.com/sbb-design-systems/sbb-angular/issues/889)
...
* **autocomplete:** implement autocomplete hint ([#158](https://github.com/sbb-design-systems/sbb-angular/issues/158)) ([df5f9d2](https://github.com/sbb-design-systems/sbb-angular/commit/df5f9d2da147714189d58c163b60a5fcdd941f3b)), closes [#154](https://github.com/sbb-design-systems/sbb-angular/issues/154)
* **business/accordion:** expose accordion for business ([#99](https://github.com/sbb-design-systems/sbb-angular/issues/99)) ([1c231fd](https://github.com/sbb-design-systems/sbb-angular/commit/1c231fd895a9661bf43e525509874d4cd85a2962)), closes [#77](https://github.com/sbb-design-systems/sbb-angular/issues/77)
* **business/autocomplete:** expose autocomplete component for business ([#42](https://github.com/sbb-design-systems/sbb-angular/issues/42)) ([b7ec7c0](https://github.com/sbb-design-systems/sbb-angular/commit/b7ec7c05f39296e5d9250286f7275f3056cc2261))
* **business/button:** expose button component for business ([#39](https://github.com/sbb-design-systems/sbb-angular/issues/39)) ([ed990a2](https://github.com/sbb-design-systems/sbb-angular/commit/ed990a2ad215f01043118613c423aff7160a2da4))
* **business/checkbox:** expose checkbox component for business ([#51](https://github.com/sbb-design-systems/sbb-angular/issues/51)) ([d666901](https://github.com/sbb-design-systems/sbb-angular/commit/d666901d80df3210bd7027ef0739d7678c51431d))
* **business/datepicker:** expose datepicker component for business  ([#47](https://github.com/sbb-design-systems/sbb-angular/issues/47)) ([57a075d](https://github.com/sbb-design-systems/sbb-angular/commit/57a075d6fdb647a1c41999445f21e1bc8856ce4d))
* **business/field:** expose field component for business applications ([#32](https://github.com/sbb-design-systems/sbb-angular/issues/32)) ([403a97d](https://github.com/sbb-design-systems/sbb-angular/commit/403a97dda535bec4fb5b2068b74c32d82a67ffde))
* **business/header:** implement header component ([#148](https://github.com/sbb-design-systems/sbb-angular/issues/148)) ([daf44cb](https://github.com/sbb-design-systems/sbb-angular/commit/daf44cbf68c76d8c5eadb06d3d0faae5cecd1fa1))
* **business/processflow:** implement processflow for business ([#153](https://github.com/sbb-design-systems/sbb-angular/issues/153)) ([0e00da6](https://github.com/sbb-design-systems/sbb-angular/commit/0e00da68fcf37a7b10a507539ab9091b68c0a220)), closes [#140](https://github.com/sbb-design-systems/sbb-angular/issues/140)
* **business/radio-button:** expose radio-button component for business  ([#43](https://github.com/sbb-design-systems/sbb-angular/issues/43)) ([7a81107](https://github.com/sbb-design-systems/sbb-angular/commit/7a81107999f7e14a03b1102c747e57f7a2eaf2b6))
* **business/select:** expose select component for business ([#41](https://github.com/sbb-design-systems/sbb-angular/issues/41)) ([0841237](https://github.com/sbb-design-systems/sbb-angular/commit/08412370488945364c4094a7226afaaba573ce0d))
* **business/textarea:** expose textarea component for business  ([#34](https://github.com/sbb-design-systems/sbb-angular/issues/34)) ([997be3c](https://github.com/sbb-design-systems/sbb-angular/commit/997be3c673e008930961b382815dd422c50973d3))
* **business/time-input:** expose time input component for business applications ([#33](https://github.com/sbb-design-systems/sbb-angular/issues/33)) ([b87a4a3](https://github.com/sbb-design-systems/sbb-angular/commit/b87a4a32e678adf17a8d266215843725b299a041))
* **business:** adapt usermenu styling ([#190](https://github.com/sbb-design-systems/sbb-angular/issues/190)) ([0b36f48](https://github.com/sbb-design-systems/sbb-angular/commit/0b36f4864207276cc9d387a26e2aa654c03e34e7)), closes [#91](https://github.com/sbb-design-systems/sbb-angular/issues/91)
...
* **business:** implement app chooser and responsive mode for header ([#192](https://github.com/sbb-design-systems/sbb-angular/issues/192)) ([4d99161](https://github.com/sbb-design-systems/sbb-angular/commit/4d99161e5451bf8e159740df80a16d0150f56acd))
...
* **business:** implement contextmenu ([#163](https://github.com/sbb-design-systems/sbb-angular/issues/163)) ([23fea1f](https://github.com/sbb-design-systems/sbb-angular/commit/23fea1f00482df02efb9c330b32d9f3d2af38170)), closes [#80](https://github.com/sbb-design-systems/sbb-angular/issues/80)
* **business:** implement dialog component ([#202](https://github.com/sbb-design-systems/sbb-angular/issues/202)) ([e625c59](https://github.com/sbb-design-systems/sbb-angular/commit/e625c598d03020c1bc7c741631998801f3fdb79b)), closes [#92](https://github.com/sbb-design-systems/sbb-angular/issues/92)
* **business:** implement hover mode for tooltip ([#170](https://github.com/sbb-design-systems/sbb-angular/issues/170)) ([f25430f](https://github.com/sbb-design-systems/sbb-angular/commit/f25430fd6be651ba3b069799ad0b2ead6ef14fd2)), closes [#110](https://github.com/sbb-design-systems/sbb-angular/issues/110)
* **business:** implement pagination business styles ([#241](https://github.com/sbb-design-systems/sbb-angular/issues/241)) ([ce21a44](https://github.com/sbb-design-systems/sbb-angular/commit/ce21a44c8aaf1927eea8705b90a7b13a155606f6)), closes [#84](https://github.com/sbb-design-systems/sbb-angular/issues/84)
* **business:** implement responsive menus for header ([#224](https://github.com/sbb-design-systems/sbb-angular/issues/224)) ([688bcf4](https://github.com/sbb-design-systems/sbb-angular/commit/688bcf471ba681ef4d83f381a4d38519abbd8e1d))
...
* **business:** implement table component ([#240](https://github.com/sbb-design-systems/sbb-angular/issues/240)) ([ea278c4](https://github.com/sbb-design-systems/sbb-angular/commit/ea278c4f7c95d4944b28974421aec77b0973c3f1)), closes [#88](https://github.com/sbb-design-systems/sbb-angular/issues/88)
* **business:** implement tabs ([#210](https://github.com/sbb-design-systems/sbb-angular/issues/210)) ([dda0b43](https://github.com/sbb-design-systems/sbb-angular/commit/dda0b438c17a35708b1200be401ab8383c58c3ac))
...
* **business:** style tabs according to style guide ([#251](https://github.com/sbb-design-systems/sbb-angular/issues/251)) ([c0491d5](https://github.com/sbb-design-systems/sbb-angular/commit/c0491d539a061a2cf44ea99459f8bc81f22ef480))
...
* **ci:** Set up ci/cd with Travis CI ([bcf4082](https://github.com/sbb-design-systems/sbb-angular/commit/bcf40825a4ec637a8ee19c5da67241dbe4dd23dd))
...
* **core:** add sbb sso constants ([#205](https://github.com/sbb-design-systems/sbb-angular/issues/205)) ([ca67252](https://github.com/sbb-design-systems/sbb-angular/commit/ca672525cfd1ff2afaf87c46462dac2b99e3c765))
...
* **core:** provide standalone-friendly APIs for date adapters ([#2146](https://github.com/sbb-design-systems/sbb-angular/issues/2146)) ([48d5793](https://github.com/sbb-design-systems/sbb-angular/commit/48d5793fca14e9497e9bd372a4b96c3538b7d812)), closes [#2066](https://github.com/sbb-design-systems/sbb-angular/issues/2066)
* expose secondary endpoints for all modules ([#156](https://github.com/sbb-design-systems/sbb-angular/issues/156)) ([cb10b27](https://github.com/sbb-design-systems/sbb-angular/commit/cb10b276762549a73f28a90b7a4e6149ad1fb937)), closes [#147](https://github.com/sbb-design-systems/sbb-angular/issues/147)
...
* github preparation ([#1](https://github.com/sbb-design-systems/sbb-angular/issues/1)) ([7b73b5e](https://github.com/sbb-design-systems/sbb-angular/commit/7b73b5e21653b20b264f85a30aac2af3511721eb))
* **header:** allow custom components for user menu and as additional header elements ([a4cf3e6](https://github.com/sbb-design-systems/sbb-angular/commit/a4cf3e6ce980c04dd0b4c61042fc0cb57c86fd9b))
* **i18n:** applies common pattern for i18n ids ([#56](https://github.com/sbb-design-systems/sbb-angular/issues/56)) ([d2c1838](https://github.com/sbb-design-systems/sbb-angular/commit/d2c183808f61c45cf500a122f4456defad751152))
* **icons:** generate new icon modules ([#258](https://github.com/sbb-design-systems/sbb-angular/issues/258)) ([539a2d4](https://github.com/sbb-design-systems/sbb-angular/commit/539a2d437df49283acfc4160298f938384bbbce8)), closes [#152](https://github.com/sbb-design-systems/sbb-angular/issues/152)
...
* **journey-maps:** add extrusion layer ([#2448](https://github.com/sbb-design-systems/sbb-angular/issues/2448)) ([a6089e6](https://github.com/sbb-design-systems/sbb-angular/commit/a6089e6ca9a01bc8bafbaecd5ac7a812bd8d9041))
...
* **journey-maps:** add new poi subcategory 'sharing_zone' ([#2567](https://github.com/sbb-design-systems/sbb-angular/issues/2567)) ([0dff036](https://github.com/sbb-design-systems/sbb-angular/commit/0dff036fcd4dedbdea1e80cf58757e37168b6788))
...
* **journey-maps:** added high-contrast-mode controls to horizontal level switch ([#2167](https://github.com/sbb-design-systems/sbb-angular/issues/2167)) ([0d5a2e3](https://github.com/sbb-design-systems/sbb-angular/commit/0d5a2e35bda4ee76f64092358d14af8e882870d4))
...
* **journey-maps:** dark mode for UI-elements ([#2150](https://github.com/sbb-design-systems/sbb-angular/issues/2150)) ([b239bc8](https://github.com/sbb-design-systems/sbb-angular/commit/b239bc817c8da25785985ccb415833e59ae6547f))
...
* **journey-maps:** enable map rotation and pitch ([#2444](https://github.com/sbb-design-systems/sbb-angular/issues/2444)) ([e599daf](https://github.com/sbb-design-systems/sbb-angular/commit/e599dafe3c929ee5e3d9f9e758dbfbee41a51f29))
* **journey-maps:** enable start level even without leit-pois ([#2214](https://github.com/sbb-design-systems/sbb-angular/issues/2214)) ([28a4c73](https://github.com/sbb-design-systems/sbb-angular/commit/28a4c73be9947486b7f2280173aaf12ade3fb5a8))
...
* **journey-maps:** horizontal level switch ([#2145](https://github.com/sbb-design-systems/sbb-angular/issues/2145)) ([87b94e9](https://github.com/sbb-design-systems/sbb-angular/commit/87b94e9935c3d19e3cac21c845fcd1d29d83ae83))
* **journey-maps:** implement esri-plugin ([#2134](https://github.com/sbb-design-systems/sbb-angular/issues/2134)) ([db395a1](https://github.com/sbb-design-systems/sbb-angular/commit/db395a1e0f6832b2bce19293b1598a03918b605b))
...
* **journey-maps:** journey-pois category new park subcategory ([#2641](https://github.com/sbb-design-systems/sbb-angular/issues/2641)) ([9ebd2ab](https://github.com/sbb-design-systems/sbb-angular/commit/9ebd2ab7ff8ad5df5aadfed68993d39eef7471f1))
...
* **journey-maps:** migrate to maplibre 3.6.1 ([#2095](https://github.com/sbb-design-systems/sbb-angular/issues/2095)) ([6d6e9ba](https://github.com/sbb-design-systems/sbb-angular/commit/6d6e9ba1fa579968060e11e62cfb0b1eff33eaad))
...
* **journey-maps:** new input field for journey-routes data ([#2346](https://github.com/sbb-design-systems/sbb-angular/issues/2346)) ([544ec19](https://github.com/sbb-design-systems/sbb-angular/commit/544ec19fba153111fd1864670c3ed191ffd467cc))
* **journey-maps:** new option to set the display of POIs as round icons ([#2409](https://github.com/sbb-design-systems/sbb-angular/issues/2409)) ([f6a73ba](https://github.com/sbb-design-systems/sbb-angular/commit/f6a73ba0e250def09b25b6c75dae7b8ce969937e))
* **journey-maps:** new POIs category p2p_car_sharing ([#2108](https://github.com/sbb-design-systems/sbb-angular/issues/2108)) ([fb8ec8d](https://github.com/sbb-design-systems/sbb-angular/commit/fb8ec8d3443612baf770b0e72519830420ac6595))
* **journey-maps:** new-style compatibility ([#2342](https://github.com/sbb-design-systems/sbb-angular/issues/2342)) ([1189ace](https://github.com/sbb-design-systems/sbb-angular/commit/1189ace80398cdabfce59096ae92754fa521fdf9))
...
* **journeyMaps:** bind method for web component ([#1928](https://github.com/sbb-design-systems/sbb-angular/issues/1928)) ([e58b6cb](https://github.com/sbb-design-systems/sbb-angular/commit/e58b6cb07d6ddaa1a5a4f67ba80423ba0ee288c6))
...
* **multiple:** make SBB Angular CSP compatible ([#2423](https://github.com/sbb-design-systems/sbb-angular/issues/2423)) ([32b94ee](https://github.com/sbb-design-systems/sbb-angular/commit/32b94ee7986993abe54276ecc3d4bc95f07063a3))
...
* **multiple:** switch to angular's new built-in control-flow ([#2120](https://github.com/sbb-design-systems/sbb-angular/issues/2120)) ([a8d0fc8](https://github.com/sbb-design-systems/sbb-angular/commit/a8d0fc85a2ae52380ea83f641ecdc592c285c355))
...
* provide sbb-radio-group for radio-button type components ([#186](https://github.com/sbb-design-systems/sbb-angular/issues/186)) ([bc7cad2](https://github.com/sbb-design-systems/sbb-angular/commit/bc7cad273b0e350437b154186582517c7d20f990)), closes [#184](https://github.com/sbb-design-systems/sbb-angular/issues/184)
* provide schematics for generating icon modules ([#259](https://github.com/sbb-design-systems/sbb-angular/issues/259)) ([00bd71b](https://github.com/sbb-design-systems/sbb-angular/commit/00bd71ba6f3183e5dc7fd0f103beb52dafcf6941))
...
* **public:** add optional callbacks to jump marks in notification ([#211](https://github.com/sbb-design-systems/sbb-angular/issues/211)) ([302dc24](https://github.com/sbb-design-systems/sbb-angular/commit/302dc2471ac675150b9b973b1cdcdda48ec02712)), closes [#131](https://github.com/sbb-design-systems/sbb-angular/issues/131)
* **public:** use perfect-scrollbar in sbb-table ([#173](https://github.com/sbb-design-systems/sbb-angular/issues/173)) ([b817f21](https://github.com/sbb-design-systems/sbb-angular/commit/b817f21ce1f0d040f74300496c173ef4cccd8343)), closes [#35](https://github.com/sbb-design-systems/sbb-angular/issues/35)
...
* **sbb-journey-maps:** remove zone.js for web components ([#2045](https://github.com/sbb-design-systems/sbb-angular/issues/2045)) ([069dc79](https://github.com/sbb-design-systems/sbb-angular/commit/069dc7907e17dff299d81a7fa9dc9d7a6d6ce7e2))
...
* add missing CommonModule in Showcase ([#2427](https://github.com/sbb-design-systems/sbb-angular/issues/2427)) ([06f2fd1](https://github.com/sbb-design-systems/sbb-angular/commit/06f2fd1f312b63d29a7e7cf446d7fe03a86253e1))
...
* add types for journey maps web component ([#2570](https://github.com/sbb-design-systems/sbb-angular/issues/2570)) ([18e150c](https://github.com/sbb-design-systems/sbb-angular/commit/18e150c96e82cb49915eeca78966449ce2917344)), closes [#2569](https://github.com/sbb-design-systems/sbb-angular/issues/2569)
...
* **angular/accordion:** prevent focus from entering the panel while it's animating ([#2468](https://github.com/sbb-design-systems/sbb-angular/issues/2468)) ([5719fda](https://github.com/sbb-design-systems/sbb-angular/commit/5719fda127b2052c4d1863472f8379be753425e3))
* **angular/accordion:** remove dependency on animations module ([#2509](https://github.com/sbb-design-systems/sbb-angular/issues/2509)) ([a11d78c](https://github.com/sbb-design-systems/sbb-angular/commit/a11d78c6d93a3067f1e4931f72a8c9100672e567))
* **angular/accordion:** switch away from animations module ([#2469](https://github.com/sbb-design-systems/sbb-angular/issues/2469)) ([65435d3](https://github.com/sbb-design-systems/sbb-angular/commit/65435d3cae9c3fa27509c9f356c3737c0f6b6be0))
...
* **angular/autocomplete:** clear selected option if it is removed while typing ([#2176](https://github.com/sbb-design-systems/sbb-angular/issues/2176)) ([e4a6d97](https://github.com/sbb-design-systems/sbb-angular/commit/e4a6d975d8378bd2aa8510b28d238ff4826cdc88)), closes [#2010](https://github.com/sbb-design-systems/sbb-angular/issues/2010)
...
* **angular/autocomplete:** don't throw NG0911 when destroyed during rendering ([#2636](https://github.com/sbb-design-systems/sbb-angular/issues/2636)) ([2dd72b4](https://github.com/sbb-design-systems/sbb-angular/commit/2dd72b484f93b3947e5d94f3f7f4d05e7f41a2e2)), closes [#2515](https://github.com/sbb-design-systems/sbb-angular/issues/2515)
...
* **angular/autocomplete:** remove dependency on NgClass ([#2254](https://github.com/sbb-design-systems/sbb-angular/issues/2254)) ([a51883b](https://github.com/sbb-design-systems/sbb-angular/commit/a51883bd2321ec363e6547167b1e529a437c6c69))
...
* **angular/autocomplete:** requireSelection sometimes not clearing value ([#2213](https://github.com/sbb-design-systems/sbb-angular/issues/2213)) ([2a24130](https://github.com/sbb-design-systems/sbb-angular/commit/2a241308579dd222934aae2c407a211536cfc604))
...
* **angular/badge:** fix badge positioning on icon ([#2246](https://github.com/sbb-design-systems/sbb-angular/issues/2246)) ([babc3fa](https://github.com/sbb-design-systems/sbb-angular/commit/babc3fa43c77a8449f69e127109da3c721bcc1fc)), closes [#2225](https://github.com/sbb-design-systems/sbb-angular/issues/2225)
...
* **angular/checkbox:** add aria-checked ([#2069](https://github.com/sbb-design-systems/sbb-angular/issues/2069)) ([7666cf8](https://github.com/sbb-design-systems/sbb-angular/commit/7666cf83f14f9eedab22baaa56e084fc08aeef5c))
...
* **angular/checkbox:** move required validation into component ([#2168](https://github.com/sbb-design-systems/sbb-angular/issues/2168)) ([9aa8d43](https://github.com/sbb-design-systems/sbb-angular/commit/9aa8d437e395fd60f8f56379dab1303e47b6b56a))
...
* **angular/chips:** simplify repeat chip removal prevention ([#2270](https://github.com/sbb-design-systems/sbb-angular/issues/2270)) ([a27e167](https://github.com/sbb-design-systems/sbb-angular/commit/a27e167dc440cd856673243f78fca7b08585f3cd))
* **angular/chips:** simplify repeat chip removal prevention ([#2315](https://github.com/sbb-design-systems/sbb-angular/issues/2315)) ([d0fbc5f](https://github.com/sbb-design-systems/sbb-angular/commit/d0fbc5f9b725be077175cfda68d3d5314c90bb9b))
...
* **angular/core:** mark fields on HasErrorState as nullable ([#2219](https://github.com/sbb-design-systems/sbb-angular/issues/2219)) ([310bbe2](https://github.com/sbb-design-systems/sbb-angular/commit/310bbe267c72f90fa598962dbd46a76816118286))
...
* **angular/datepicker:** avoid losing focus when re-rendering the current view ([#2332](https://github.com/sbb-design-systems/sbb-angular/issues/2332)) ([5542da6](https://github.com/sbb-design-systems/sbb-angular/commit/5542da61a075648cbbbfa426b6e83c46590e01f1))
...
* **angular/datepicker:** remove dependency on NgClass ([#2253](https://github.com/sbb-design-systems/sbb-angular/issues/2253)) ([783d99d](https://github.com/sbb-design-systems/sbb-angular/commit/783d99d42ac89c1c2534764c45af86babf135211))
...
* **angular/datepicker:** resolve repeater warnings in calendar ([#2269](https://github.com/sbb-design-systems/sbb-angular/issues/2269)) ([b2d43a4](https://github.com/sbb-design-systems/sbb-angular/commit/b2d43a4c78d6e94eb1ccec83a78f44be007c474c))
...
* **angular/dialog:** mark dialog content as scrollable ([#2257](https://github.com/sbb-design-systems/sbb-angular/issues/2257)) ([e32959c](https://github.com/sbb-design-systems/sbb-angular/commit/e32959c77823ca438218286e3b21b1ad8f4d9a70))
* **angular/dialog:** provide dialog service in root ([#2307](https://github.com/sbb-design-systems/sbb-angular/issues/2307)) ([148d4ac](https://github.com/sbb-design-systems/sbb-angular/commit/148d4ace097b45acd3cfdfb963738ea3481c37bb))
* **angular/dialog:** remove usages of deprecated ComponentFactoryResolver ([#2387](https://github.com/sbb-design-systems/sbb-angular/issues/2387)) ([f7eea1c](https://github.com/sbb-design-systems/sbb-angular/commit/f7eea1c8bc3e64cc589a664cd79403b5fc92c256))
* **angular/dialog:** return `undefined` when closing dialog via header button ([#2629](https://github.com/sbb-design-systems/sbb-angular/issues/2629)) ([30fa841](https://github.com/sbb-design-systems/sbb-angular/commit/30fa841210672577a0edb4d0813fa8d2356a0ccb)), closes [#2496](https://github.com/sbb-design-systems/sbb-angular/issues/2496)
* **angular/dialog:** sbb-dialog-title should work under OnPush `viewContainerRef` ([#2158](https://github.com/sbb-design-systems/sbb-angular/issues/2158)) ([f661602](https://github.com/sbb-design-systems/sbb-angular/commit/f6616025073b1a46b31aea958cc9add708bebbeb))
...
* **angular/dialog:** use enum instead of const enum ([#2174](https://github.com/sbb-design-systems/sbb-angular/issues/2174)) ([87888e7](https://github.com/sbb-design-systems/sbb-angular/commit/87888e749c2304084889512bfc411c38af3b3a8e))
...
* **angular/file-selector:** allow disabling multiple mode ([#2245](https://github.com/sbb-design-systems/sbb-angular/issues/2245)) ([0121a8e](https://github.com/sbb-design-systems/sbb-angular/commit/0121a8e1700aa7c95cef31421bb715ba528ca5dc)), closes [#2238](https://github.com/sbb-design-systems/sbb-angular/issues/2238)
...
* **angular/form-field:** update state if control changes ([#2349](https://github.com/sbb-design-systems/sbb-angular/issues/2349)) ([aeb6a92](https://github.com/sbb-design-systems/sbb-angular/commit/aeb6a92f5138fff88efd202731f8e80f3ef792cf))
* **angular/header-environment:** fix text color in dark mode ([#2205](https://github.com/sbb-design-systems/sbb-angular/issues/2205)) ([5c7375e](https://github.com/sbb-design-systems/sbb-angular/commit/5c7375e70ff0a5cde2034ad76e4afc0a14fc54ca)), closes [#2202](https://github.com/sbb-design-systems/sbb-angular/issues/2202)
...
* **angular/input:** change border color to smoke ([#2099](https://github.com/sbb-design-systems/sbb-angular/issues/2099)) ([82cb5d7](https://github.com/sbb-design-systems/sbb-angular/commit/82cb5d777bdc4733a062074098ba5ebe2d953472))
* **angular/input:** don't swallow the tabIndex ([#2204](https://github.com/sbb-design-systems/sbb-angular/issues/2204)) ([e7ab7b5](https://github.com/sbb-design-systems/sbb-angular/commit/e7ab7b5353fdb06b8a8fa5623fc60ab044fa4a48)), closes [#2203](https://github.com/sbb-design-systems/sbb-angular/issues/2203)
...
* **angular/input:** show spin buttons for number input ([#2473](https://github.com/sbb-design-systems/sbb-angular/issues/2473)) ([8afc30a](https://github.com/sbb-design-systems/sbb-angular/commit/8afc30ae7aeb446e3d41205f1958bd1e83b3baa9)), closes [#2380](https://github.com/sbb-design-systems/sbb-angular/issues/2380)
...
* **angular/lightbox:** provide lightbox service in root ([#2308](https://github.com/sbb-design-systems/sbb-angular/issues/2308)) ([f126ab2](https://github.com/sbb-design-systems/sbb-angular/commit/f126ab25f4a304a83d55b51a3089e45d5a136749))
...
* **angular/menu:** decouple menu lifecycle from animations ([#2467](https://github.com/sbb-design-systems/sbb-angular/issues/2467)) ([a261e31](https://github.com/sbb-design-systems/sbb-angular/commit/a261e31e7d31caac4b2c2e996d508bab9b72d177))
* **angular/menu:** do not auto-focus when hover opens menu ([#2566](https://github.com/sbb-design-systems/sbb-angular/issues/2566)) ([55d1024](https://github.com/sbb-design-systems/sbb-angular/commit/55d10244ed3cd9c1d1f132d82bd09daa4d009a6c))
* **angular/menu:** don't visually focus first item if menu is opened ([#2187](https://github.com/sbb-design-systems/sbb-angular/issues/2187)) ([4d0a730](https://github.com/sbb-design-systems/sbb-angular/commit/4d0a73098f4b291b24e09a257c98decc766d4a07)), closes [#2105](https://github.com/sbb-design-systems/sbb-angular/issues/2105)
...
* **angular/menu:** prevent child menu reopening while parent is animating away ([#2668](https://github.com/sbb-design-systems/sbb-angular/issues/2668)) ([fdf3cab](https://github.com/sbb-design-systems/sbb-angular/commit/fdf3cab9cc7eba87a842189f705a94c471578b80))
* **angular/menu:** remove dependency on animations module ([#2472](https://github.com/sbb-design-systems/sbb-angular/issues/2472)) ([52edf18](https://github.com/sbb-design-systems/sbb-angular/commit/52edf18a763bcbe9a8f270b8baa6744b10e4715a))
* **angular/menu:** remove dependency on NgClass ([#2255](https://github.com/sbb-design-systems/sbb-angular/issues/2255)) ([3a72e84](https://github.com/sbb-design-systems/sbb-angular/commit/3a72e84ab46ba926d9eede20e28d223e57b5611b))
* **angular/menu:** switch internal state to signals ([#2667](https://github.com/sbb-design-systems/sbb-angular/issues/2667)) ([3900ec2](https://github.com/sbb-design-systems/sbb-angular/commit/3900ec2c1eb0e2eacd6d7cb108b65e1eda9eb3fe))
...
* **angular/processflow:** remove IE animation workaround ([#2418](https://github.com/sbb-design-systems/sbb-angular/issues/2418)) ([8b18525](https://github.com/sbb-design-systems/sbb-angular/commit/8b185257278e81c3e2fb1da363a5cc1123a4bcf1))
...
* **angular/radio-button:** mark radio-group for check on touch ([#2294](https://github.com/sbb-design-systems/sbb-angular/issues/2294)) ([8a7c422](https://github.com/sbb-design-systems/sbb-angular/commit/8a7c422675cfea49e5be150bb402157c21824af1))
...
* **angular/radio:** ensure focus and selected states stay linked ([#2293](https://github.com/sbb-design-systems/sbb-angular/issues/2293)) ([fb8574a](https://github.com/sbb-design-systems/sbb-angular/commit/fb8574af142d9c62c9d00157c9e05d8f3867b01c))
...
* **angular/radio:** optional typing of `SbbRadioChange` ([#2492](https://github.com/sbb-design-systems/sbb-angular/issues/2492)) ([0841993](https://github.com/sbb-design-systems/sbb-angular/commit/0841993ead4751e7d206eb39815d91363602eb17))
...
* **angular/schematics:** import async animations and remove deprecated functions ([#2194](https://github.com/sbb-design-systems/sbb-angular/issues/2194)) ([6ff0019](https://github.com/sbb-design-systems/sbb-angular/commit/6ff00195c971fe6622ed33fc424601d00ec70d59))
...
* **angular/select:** add opt-in input that allows selection of nullable options ([#2466](https://github.com/sbb-design-systems/sbb-angular/issues/2466)) ([aa67bec](https://github.com/sbb-design-systems/sbb-angular/commit/aa67bec5f38c0ed543694e05392f8494a2548ec6))
...
* **angular/select:** optional typing of `SbbSelectChange` ([#2493](https://github.com/sbb-design-systems/sbb-angular/issues/2493)) ([ed01e37](https://github.com/sbb-design-systems/sbb-angular/commit/ed01e37e59a48300521bb0c18bc78c91149b37aa))
* **angular/select:** remove incompatible aria-autocomplete attribute ([#2384](https://github.com/sbb-design-systems/sbb-angular/issues/2384)) ([5e0bdbb](https://github.com/sbb-design-systems/sbb-angular/commit/5e0bdbb09ca60003650c2fe38866956e48c9d1e3))
...
* **angular/sidebar:** change dark mode background to charcoal ([#2097](https://github.com/sbb-design-systems/sbb-angular/issues/2097)) ([9843544](https://github.com/sbb-design-systems/sbb-angular/commit/9843544b86e40463331184fb3eee32f12dfbc54c))
* **angular/sidebar:** darker hover color for sidebar items in dark mode ([#2103](https://github.com/sbb-design-systems/sbb-angular/issues/2103)) ([c760d2f](https://github.com/sbb-design-systems/sbb-angular/commit/c760d2f161f5f9a60bb1f71c116996ad19cadf88))
...
* **angular/sidebar:** not closing on escape key press ([#2326](https://github.com/sbb-design-systems/sbb-angular/issues/2326)) ([065bb25](https://github.com/sbb-design-systems/sbb-angular/commit/065bb25b35468cb34c06247c6cd4587a15edf4af))
...
* **angular/sidebar:** prevent unnecessary events when switching to mobile ([#2357](https://github.com/sbb-design-systems/sbb-angular/issues/2357)) ([dd1c806](https://github.com/sbb-design-systems/sbb-angular/commit/dd1c8068793ddca28f4cec2596e958294484661b))
* **angular/sidebar:** remove IE animation workaround ([#2419](https://github.com/sbb-design-systems/sbb-angular/issues/2419)) ([62e263a](https://github.com/sbb-design-systems/sbb-angular/commit/62e263a489b7566b4654a16212c1fd7a20da31f7))
...
* **angular/sidebar:** switch away from animations module ([#2475](https://github.com/sbb-design-systems/sbb-angular/issues/2475)) ([73965ad](https://github.com/sbb-design-systems/sbb-angular/commit/73965ad40d90548073bdca57b27d92bdff4dbf5e))
...
* **angular/table:** change dark mode hover and active colors ([#2098](https://github.com/sbb-design-systems/sbb-angular/issues/2098)) ([86c46b8](https://github.com/sbb-design-systems/sbb-angular/commit/86c46b81c0f9414ed01c3d8a6da80c38896028f8))
...
* **angular/table:** fix input transforms and adjust to latest @angular/cdk ([#2211](https://github.com/sbb-design-systems/sbb-angular/issues/2211)) ([b824b7c](https://github.com/sbb-design-systems/sbb-angular/commit/b824b7cae32cd55e19e5529d9db2578793f7aff1))
...
* **angular/tabs:** allow for tablist aria-label and aria-labelledby to be set ([#2350](https://github.com/sbb-design-systems/sbb-angular/issues/2350)) ([5e28a32](https://github.com/sbb-design-systems/sbb-angular/commit/5e28a32fbc376b258c9b60f90871fa5f39a3e406))
...
* **angular/tabs:** prevent scrolling and disable interaction if disabled ([#2193](https://github.com/sbb-design-systems/sbb-angular/issues/2193)) ([0555623](https://github.com/sbb-design-systems/sbb-angular/commit/0555623ded7d1dc7971819d2e310da1f3a8eed06))
* **angular/tabs:** remove dependency on NgClass ([#2251](https://github.com/sbb-design-systems/sbb-angular/issues/2251)) ([afd99a6](https://github.com/sbb-design-systems/sbb-angular/commit/afd99a6ef97e02b9eb7b483644f811d6400a3df3))
* **angular/tabs:** remove IE animation workaround ([#2417](https://github.com/sbb-design-systems/sbb-angular/issues/2417)) ([a44ceac](https://github.com/sbb-design-systems/sbb-angular/commit/a44ceacff4b451dff680aa348f0859030e959f17))
...
* **angular/tabs:** use ResizeObserver to react to size changes ([#2234](https://github.com/sbb-design-systems/sbb-angular/issues/2234)) ([fbc4f97](https://github.com/sbb-design-systems/sbb-angular/commit/fbc4f97d70954acd62cf8b11bf8b2d4a7db7ac53))
* **angular/tabs:** use ResizeObserver to react to size changes ([#2358](https://github.com/sbb-design-systems/sbb-angular/issues/2358)) ([0f67f0c](https://github.com/sbb-design-systems/sbb-angular/commit/0f67f0ce7493215b1fdd40c511953bf07a749c62))
...
* **angular/tags:** remove tag focus on mouse blur ([#2123](https://github.com/sbb-design-systems/sbb-angular/issues/2123)) ([5745975](https://github.com/sbb-design-systems/sbb-angular/commit/5745975f7e7b4763a6d2b23c1132d3e1820185d1)), closes [#2119](https://github.com/sbb-design-systems/sbb-angular/issues/2119)
...
* **angular/tooltip:** allow disabling tooltips ([#2227](https://github.com/sbb-design-systems/sbb-angular/issues/2227)) ([7597aee](https://github.com/sbb-design-systems/sbb-angular/commit/7597aee2fdf2b1bae5ce166ac2f90e7d24ef840a)), closes [#1855](https://github.com/sbb-design-systems/sbb-angular/issues/1855)
...
* **angular/tooltip:** correct icon styling when placed inside label ([#2393](https://github.com/sbb-design-systems/sbb-angular/issues/2393)) ([6664f4b](https://github.com/sbb-design-systems/sbb-angular/commit/6664f4bc68c361c0bbb375e13643261143d53060))
...
* **angular/tooltip:** remove aria-describedby when disabled ([#2338](https://github.com/sbb-design-systems/sbb-angular/issues/2338)) ([a1cf5ae](https://github.com/sbb-design-systems/sbb-angular/commit/a1cf5ae80bbfc22f253af4612503227d41a32c77))
* **angular/tooltip:** remove old IE workaround ([#2365](https://github.com/sbb-design-systems/sbb-angular/issues/2365)) ([f78202b](https://github.com/sbb-design-systems/sbb-angular/commit/f78202b6b9d497c198361e598607c437fe5cf105))
...
* **angular/tooltip:** tooltip should mark for check when visibility changes ([#2268](https://github.com/sbb-design-systems/sbb-angular/issues/2268)) ([155d40e](https://github.com/sbb-design-systems/sbb-angular/commit/155d40ee3f0332797737918a641c070b1fbbfcac))
...
* **angular:** display button animation icon at the right position ([#768](https://github.com/sbb-design-systems/sbb-angular/issues/768)) ([6b6b697](https://github.com/sbb-design-systems/sbb-angular/commit/6b6b69733f077ae12aa331704a1f528b953ad14a))
...
* assure hidden native input elements are positioned close to label ([#248](https://github.com/sbb-design-systems/sbb-angular/issues/248)) ([d5e43e9](https://github.com/sbb-design-systems/sbb-angular/commit/d5e43e9b8edde721810d621c54472ae86df1f7a1)), closes [#243](https://github.com/sbb-design-systems/sbb-angular/issues/243)
* autocomplete freezes on backspacing ([#182](https://github.com/sbb-design-systems/sbb-angular/issues/182)) ([2e881cb](https://github.com/sbb-design-systems/sbb-angular/commit/2e881cbd1f526dd949732823a740013bc62f35e0)), closes [#144](https://github.com/sbb-design-systems/sbb-angular/issues/144)
...
* **business/accordion:** remove media query breakpoints ([#139](https://github.com/sbb-design-systems/sbb-angular/issues/139)) ([0e3d16a](https://github.com/sbb-design-systems/sbb-angular/commit/0e3d16a51c071c4f30925dc3be6444d06f6a2235))
* **business/button:** change font opacity for disabled buttons ([#53](https://github.com/sbb-design-systems/sbb-angular/issues/53)) ([977fb78](https://github.com/sbb-design-systems/sbb-angular/commit/977fb78d8fa8c9ce336e0e9addd9f3e5efb4c578))
* **business/checkbox:** add sbb-checkbox class to public and business ([#109](https://github.com/sbb-design-systems/sbb-angular/issues/109)) ([3c4a4e5](https://github.com/sbb-design-systems/sbb-angular/commit/3c4a4e516f5aad157e61ededc91b1e030da5a5ff))
* **business/field:** change gray color to fit style guide ([#55](https://github.com/sbb-design-systems/sbb-angular/issues/55)) ([fd3b6b4](https://github.com/sbb-design-systems/sbb-angular/commit/fd3b6b4cd9ab38fbd17d846d927ea8e5b8b4922e))
* **business/option:** change color of active/hover to red125 ([#59](https://github.com/sbb-design-systems/sbb-angular/issues/59)) ([ddee023](https://github.com/sbb-design-systems/sbb-angular/commit/ddee0237a9a3deb65228378864e97a38eec2dcdc))
* **business/radio-button:** change gray color of radio-buttons ([#52](https://github.com/sbb-design-systems/sbb-angular/issues/52)) ([f373ba3](https://github.com/sbb-design-systems/sbb-angular/commit/f373ba35ef783aba6e6a0893840e80de86acbc57))
...
* **business:** add icon content child to button component and template ([#188](https://github.com/sbb-design-systems/sbb-angular/issues/188)) ([93307d0](https://github.com/sbb-design-systems/sbb-angular/commit/93307d0afb9d9fb1aeb616df3d02e3280b5515cb))
...
* **business:** fix stacking order and border issue ([#234](https://github.com/sbb-design-systems/sbb-angular/issues/234)) ([54a7a36](https://github.com/sbb-design-systems/sbb-angular/commit/54a7a36b30ddc970e8f1d27d57058142a2707b34)), closes [#219](https://github.com/sbb-design-systems/sbb-angular/issues/219)
...
* **business:** show overflow for header menu ([#228](https://github.com/sbb-design-systems/sbb-angular/issues/228)) ([48e2847](https://github.com/sbb-design-systems/sbb-angular/commit/48e28476d5a90b9bbce407aaf71ec7c89fe77933))
...
* **business:** vertically center chip input label text ([#883](https://github.com/sbb-design-systems/sbb-angular/issues/883)) ([4f7443d](https://github.com/sbb-design-systems/sbb-angular/commit/4f7443d3845f9bddeee2d860d2775eb3cbe40272))
...
* check property pinMode before accessing ([#273](https://github.com/sbb-design-systems/sbb-angular/issues/273)) ([04aa454](https://github.com/sbb-design-systems/sbb-angular/commit/04aa4549b634b4c67a727caa1716bfa8e45b0aa3)), closes [#272](https://github.com/sbb-design-systems/sbb-angular/issues/272)
* **checkbox:** fix change behavior for checkboxes ([#67](https://github.com/sbb-design-systems/sbb-angular/issues/67)) ([6fac950](https://github.com/sbb-design-systems/sbb-angular/commit/6fac950b590da58ca5b8241ca17a8228073edf03)), closes [#20](https://github.com/sbb-design-systems/sbb-angular/issues/20)
* circular dependency in sbb-toggle-showcase ([#266](https://github.com/sbb-design-systems/sbb-angular/issues/266)) ([ea5d231](https://github.com/sbb-design-systems/sbb-angular/commit/ea5d231be96be8513394ee8cf6e11d629131063a))
...
* **core:** add missing sass files ([#162](https://github.com/sbb-design-systems/sbb-angular/issues/162)) ([8733e70](https://github.com/sbb-design-systems/sbb-angular/commit/8733e708db8ab1241d6f44d3974bb24c7660e220))
...
* **datepicker:** adds missing button type attributes ([#65](https://github.com/sbb-design-systems/sbb-angular/issues/65)) ([7b21600](https://github.com/sbb-design-systems/sbb-angular/commit/7b21600c3599fa1f49041b91038d925f96363dba)), closes [#61](https://github.com/sbb-design-systems/sbb-angular/issues/61)
* **datepicker:** convert 2-digit years to 19xx or 20xx ([#14](https://github.com/sbb-design-systems/sbb-angular/issues/14)) ([70b22ee](https://github.com/sbb-design-systems/sbb-angular/commit/70b22ee88e2a03f4b40b506e6edb147a727feed2)), closes [#13](https://github.com/sbb-design-systems/sbb-angular/issues/13)
* **datepicker:** fix invalid input on empty input ([#10](https://github.com/sbb-design-systems/sbb-angular/issues/10)) ([0368615](https://github.com/sbb-design-systems/sbb-angular/commit/03686150c038fc0f38976c970d8a4c5a77ebb22a)), closes [#9](https://github.com/sbb-design-systems/sbb-angular/issues/9)
* **datepicker:** fixes arrow navigation with min and max dates ([#12](https://github.com/sbb-design-systems/sbb-angular/issues/12)) ([a2d1d08](https://github.com/sbb-design-systems/sbb-angular/commit/a2d1d083131fc5934767463fd6030b162faaa37f)), closes [#11](https://github.com/sbb-design-systems/sbb-angular/issues/11)
* **datepicker:** fixes arrows change detection on manual change ([#46](https://github.com/sbb-design-systems/sbb-angular/issues/46)) ([b9c1efe](https://github.com/sbb-design-systems/sbb-angular/commit/b9c1efe2f72b9df9b749807b71c4863e36f30f42)), closes [#40](https://github.com/sbb-design-systems/sbb-angular/issues/40)
* **datepicker:** fixes slave datepicker to only trigger on calender selected date ([#45](https://github.com/sbb-design-systems/sbb-angular/issues/45)) ([47b2da8](https://github.com/sbb-design-systems/sbb-angular/commit/47b2da86b5111609efbdfd00e5ab6c834cd851a5)), closes [#36](https://github.com/sbb-design-systems/sbb-angular/issues/36)
* **datepicker:** refactor usage of TitleCasePipe to DateAdapter ([#227](https://github.com/sbb-design-systems/sbb-angular/issues/227)) ([ca0f4fa](https://github.com/sbb-design-systems/sbb-angular/commit/ca0f4faffe85b4aac45990078a3aa85777600f8f)), closes [#226](https://github.com/sbb-design-systems/sbb-angular/issues/226)
...
* **deps:** update angular ([083ce0d](https://github.com/sbb-design-systems/sbb-angular/commit/083ce0defd8ffa0b0b536414cc5846cc1626a892))
* **deps:** update angular ([8184921](https://github.com/sbb-design-systems/sbb-angular/commit/818492104a8acc2b014cecee922d6a08c95e3f7c))
...
* **deps:** update angular to v14.0.3 ([00ecf31](https://github.com/sbb-design-systems/sbb-angular/commit/00ecf3185fbf215e7c4fdc8e9627f586b007404c))
* **deps:** update angular to v14.2.1 ([a6c862f](https://github.com/sbb-design-systems/sbb-angular/commit/a6c862f1881ae1b4bc6972b75ce3d6573128adbe))
* **deps:** update angular to v14.2.3 ([018a9af](https://github.com/sbb-design-systems/sbb-angular/commit/018a9af3f1c1c84e54274950e09f51869f4b1017))
* **deps:** update angular to v14.2.7 ([fdeed09](https://github.com/sbb-design-systems/sbb-angular/commit/fdeed09625cee312be8b1d6f0808921d10097837))
...
* **deps:** update angular to v16.0.3 ([a82771e](https://github.com/sbb-design-systems/sbb-angular/commit/a82771ee6bdd84b89da51277b05b8d5fc517c2bb))
* **deps:** update angular to v16.1.2 ([8b7cc63](https://github.com/sbb-design-systems/sbb-angular/commit/8b7cc63feca395b56d92da964e0be286a74f6bea))
* **deps:** update angular to v16.1.4 ([03be5ff](https://github.com/sbb-design-systems/sbb-angular/commit/03be5ff9c0ded77c75f9350392bbf378d7837379))
* **deps:** update angular to v16.1.5 ([dfaf547](https://github.com/sbb-design-systems/sbb-angular/commit/dfaf547f2168922efce17c2d360d7757b9670646))
* **deps:** update angular to v16.1.6 ([df64ba1](https://github.com/sbb-design-systems/sbb-angular/commit/df64ba1383a16e17bd1c7650da5e298360854d90))
* **deps:** update angular to v16.2.1 ([#1970](https://github.com/sbb-design-systems/sbb-angular/issues/1970)) ([33c3915](https://github.com/sbb-design-systems/sbb-angular/commit/33c3915404156ef61a2fbf6eb3b4648fe78c8deb))
* **deps:** update angular to v16.2.2 ([73dd2ee](https://github.com/sbb-design-systems/sbb-angular/commit/73dd2ee5a231ab9be89afe06a5be9eafd5ff16d9))
* **deps:** update angular to v16.2.4 ([7fd8355](https://github.com/sbb-design-systems/sbb-angular/commit/7fd8355346297c20892e3edb2b75a822594b2b2a))
* **deps:** update angular to v17.0.1 ([beed0c0](https://github.com/sbb-design-systems/sbb-angular/commit/beed0c0f38ea3416fefacede801504cec2383bc2))
* **deps:** update angular to v17.0.2 ([eaabdb1](https://github.com/sbb-design-systems/sbb-angular/commit/eaabdb10bcc4afc48b8942a315abaae4162e1b91))
* **deps:** update angular to v17.0.7 ([b44153c](https://github.com/sbb-design-systems/sbb-angular/commit/b44153cc8b11294e9e13b179acd5a91f09cb1d92))
* **deps:** update angular to v17.1.1 ([9bf9d95](https://github.com/sbb-design-systems/sbb-angular/commit/9bf9d9573b34066c859756c60167e907a212eccc))
* **deps:** update angular to v17.2.2 ([9bccecb](https://github.com/sbb-design-systems/sbb-angular/commit/9bccecb724fdc251554b73450dedb8b97cc29a31))
* **deps:** update angular to v17.2.3 ([02353c5](https://github.com/sbb-design-systems/sbb-angular/commit/02353c5258a51f7bca9c4802da1c91d849f320d4))
* **deps:** update angular to v17.3.0 ([315df17](https://github.com/sbb-design-systems/sbb-angular/commit/315df170525836f693d83299c9fdca51930dc7b2))
* **deps:** update angular to v17.3.1 ([eb15fbd](https://github.com/sbb-design-systems/sbb-angular/commit/eb15fbd5d0eda1feef4831c05239dc84fb3f7142))
* **deps:** update angular to v17.3.2 ([b09e242](https://github.com/sbb-design-systems/sbb-angular/commit/b09e24254fea8fcaa33467537be341641a58e4a7))
* **deps:** update angular to v17.3.4 ([3ecd024](https://github.com/sbb-design-systems/sbb-angular/commit/3ecd0247ca715634e5e80470444dfe32b03939ca))
* **deps:** update angular to v18.0.0-rc.2 (main) ([#2264](https://github.com/sbb-design-systems/sbb-angular/issues/2264)) ([0afc4cc](https://github.com/sbb-design-systems/sbb-angular/commit/0afc4cc9f43bfd89ffee19c953bddb3d2f2395aa))
* **deps:** update angular to v18.0.5 ([#2300](https://github.com/sbb-design-systems/sbb-angular/issues/2300)) ([4c8a91e](https://github.com/sbb-design-systems/sbb-angular/commit/4c8a91ef808788bb783636dbdee9de51d3ef86c9))
* **deps:** update angular to v18.2.5 ([c3078fe](https://github.com/sbb-design-systems/sbb-angular/commit/c3078fea93d8baef50e7ebfba3c87dedaffc5db3))
* **deps:** update angular to v18.2.8 ([d82b29e](https://github.com/sbb-design-systems/sbb-angular/commit/d82b29e38cf2ebb864b3af772ffa09f88161b5ea))
* **deps:** update angular to v19.0.0-rc.0 ([b07cc29](https://github.com/sbb-design-systems/sbb-angular/commit/b07cc29c1489369d9bc89e35185af545b815b497))
* **deps:** update angular to v19.0.0-rc.1 ([2415d86](https://github.com/sbb-design-systems/sbb-angular/commit/2415d8612fe33bd12436710dd5405c0b95cbcaa3))
* **deps:** update angular to v19.0.0-rc.3 ([0b55bf9](https://github.com/sbb-design-systems/sbb-angular/commit/0b55bf9ae84acad68047cc125cb721f0044c56cd))
* **deps:** update angular to v19.0.1 ([f55ec78](https://github.com/sbb-design-systems/sbb-angular/commit/f55ec7806f9ada41f008f254c2e351538a07a23b))
* **deps:** update angular to v19.1.4 ([6331727](https://github.com/sbb-design-systems/sbb-angular/commit/6331727d15cf58f0429c0066a34db5418344e318))
* **deps:** update angular to v19.1.5 ([0ae9a25](https://github.com/sbb-design-systems/sbb-angular/commit/0ae9a2595b482a8d9fc28040bd29c92be57f5e9e))
* **deps:** update dependency @angular/cdk to v13.3.1 ([#1329](https://github.com/sbb-design-systems/sbb-angular/issues/1329)) ([086ac4c](https://github.com/sbb-design-systems/sbb-angular/commit/086ac4ca8463f7fe05ed97b8f9b395b67c79ce79))
...
* **deps:** update dependency @angular/cdk to v14.0.2 ([#1541](https://github.com/sbb-design-systems/sbb-angular/issues/1541)) ([96ec2c6](https://github.com/sbb-design-systems/sbb-angular/commit/96ec2c67b378dd5ffc930b75f2b03e54ffbb22a0))
* **deps:** update dependency @angular/cdk to v14.0.5 ([3e11dfe](https://github.com/sbb-design-systems/sbb-angular/commit/3e11dfec21c0945d48e04737608316215db8836a))
* **deps:** update dependency @angular/cdk to v14.1.2 ([e3ec27d](https://github.com/sbb-design-systems/sbb-angular/commit/e3ec27d13aae708891e4b7f93a817d75d44460a6))
* **deps:** update dependency @angular/cdk to v14.1.3 ([5946124](https://github.com/sbb-design-systems/sbb-angular/commit/5946124bde782a3bdae74a5b828b5392d62901b8))
* **deps:** update dependency @angular/cdk to v14.2.2 ([d2b3b48](https://github.com/sbb-design-systems/sbb-angular/commit/d2b3b48c88001406cdbf50d2c9cf145f82e39529))
...
* **deps:** update dependency @angular/cdk to v16.0.1 ([8fd2f5c](https://github.com/sbb-design-systems/sbb-angular/commit/8fd2f5c89272b9a43bc93c88a1aa77b1c409dbdb))
* **deps:** update dependency @angular/cdk to v16.1.1 ([#1920](https://github.com/sbb-design-systems/sbb-angular/issues/1920)) ([85f4f08](https://github.com/sbb-design-systems/sbb-angular/commit/85f4f086db4950cda2e7a1dc3e918acbb994e700))
* **deps:** update dependency @angular/cdk to v16.1.2 ([f1a1238](https://github.com/sbb-design-systems/sbb-angular/commit/f1a1238bfe94a97e3d444bfeb7afa6cd8b2f0aa8))
* **deps:** update dependency @angular/cdk to v16.1.5 ([ade0055](https://github.com/sbb-design-systems/sbb-angular/commit/ade0055ec74ffc8a8fa8692736812934aa3782b7))
* **deps:** update dependency @angular/cdk to v16.2.3 ([88375cc](https://github.com/sbb-design-systems/sbb-angular/commit/88375cc7f765c505d1c16e39520b59a167c1b1bf))
* **deps:** update dependency @angular/cdk to v17.0.1 ([0f07464](https://github.com/sbb-design-systems/sbb-angular/commit/0f074648f806d7f25debcee9457263e8c8872590))
* **deps:** update dependency @angular/cdk to v17.0.2 ([9394021](https://github.com/sbb-design-systems/sbb-angular/commit/93940210dc88404cf4005b39a19fcb0c8aea8e82))
* **deps:** update dependency @angular/cdk to v17.0.3 ([899d92a](https://github.com/sbb-design-systems/sbb-angular/commit/899d92a53740a2d9537a6c80ab15ab28a9fa89a4))
* **deps:** update dependency @angular/cdk to v17.1.1 ([0687645](https://github.com/sbb-design-systems/sbb-angular/commit/0687645622d07f55393e65c0cf7add8b54662843))
* **deps:** update dependency @angular/cdk to v17.3.0 ([322a15c](https://github.com/sbb-design-systems/sbb-angular/commit/322a15c0fc7713bb8b499bfc9faaee4490c72575))
* **deps:** update dependency @angular/cdk to v17.3.2 ([c2e17df](https://github.com/sbb-design-systems/sbb-angular/commit/c2e17df4cffa795c7baebced61967ab43b93c65f))
* **deps:** update dependency @angular/cdk to v18.2.4 ([#2374](https://github.com/sbb-design-systems/sbb-angular/issues/2374)) ([2a692da](https://github.com/sbb-design-systems/sbb-angular/commit/2a692dae1881e92c3574b5d77fc7ed4c0a53da16))
* **deps:** update dependency @angular/cdk to v18.2.5 ([260cf6b](https://github.com/sbb-design-systems/sbb-angular/commit/260cf6b98b42722f6651b61d59ae3e0e10717a3d))
* **deps:** update dependency @angular/cdk to v18.2.7 ([29b08f3](https://github.com/sbb-design-systems/sbb-angular/commit/29b08f38ae5088215c3e87848fcc1674b3d30ca3))
* **deps:** update dependency @angular/cdk to v18.2.9 ([6c7dfa0](https://github.com/sbb-design-systems/sbb-angular/commit/6c7dfa0b5466b9f9f46d4229d0d598c8d007ec98))
* **deps:** update dependency @angular/cdk to v19.0.0-rc.2 ([459b4f2](https://github.com/sbb-design-systems/sbb-angular/commit/459b4f2df033d9e809aeaf138e66880dc3f9bdb5))
* **deps:** update dependency @angular/cdk to v19.0.1 ([fc1ab73](https://github.com/sbb-design-systems/sbb-angular/commit/fc1ab73c836ba45daa6ea97907bd51879b7ccae5))
* **deps:** update dependency @angular/cdk to v19.0.3 ([292f1a9](https://github.com/sbb-design-systems/sbb-angular/commit/292f1a9904aa039e3792eeddb467111c8087842a))
* **deps:** update dependency @angular/cdk to v19.1.2 ([7b9c16f](https://github.com/sbb-design-systems/sbb-angular/commit/7b9c16f62bcde393c515d8bc65cddc17e28ff860))
* **deps:** update dependency @stackblitz/sdk to v1.10.0 ([2d73396](https://github.com/sbb-design-systems/sbb-angular/commit/2d7339697dbee0056b64e0e9dea3a0b93fb89278))
* **deps:** update dependency @stackblitz/sdk to v1.11.0 ([ad40e2f](https://github.com/sbb-design-systems/sbb-angular/commit/ad40e2f1b76bd658348741ec4a79c90207e579dc))
...
* **deps:** update dependency @stackblitz/sdk to v1.8.1 ([87f7799](https://github.com/sbb-design-systems/sbb-angular/commit/87f7799baee30678bc9fb3b5501ee993ccfdc8e4))
...
* **deps:** update dependency maplibre-gl to v2.4.0 (main) ([#1648](https://github.com/sbb-design-systems/sbb-angular/issues/1648)) ([1d43ad0](https://github.com/sbb-design-systems/sbb-angular/commit/1d43ad0e5ac881fa7e9a83dd681c1af061799049))
* **deps:** update dependency maplibre-gl to v3.6.2 ([8322709](https://github.com/sbb-design-systems/sbb-angular/commit/8322709020b2e18899427cf40ce6d2850d31f01e))
...
* **deps:** update dependency rxjs to v7.5.7 ([f8951bc](https://github.com/sbb-design-systems/sbb-angular/commit/f8951bce29c0f49bb8732e54fd0d30e9ddf42462))
...
* **deps:** update dependency tslib to v2.4.1 ([38a49b0](https://github.com/sbb-design-systems/sbb-angular/commit/38a49b0d12fff0387c88bd32ca068af365c1c376))
...
* **deps:** update dependency tslib to v2.5.1 ([2679402](https://github.com/sbb-design-systems/sbb-angular/commit/26794025231e441f4a561858c0f935dfa6bf0d61))
* **deps:** update dependency tslib to v2.5.2 ([f4f7c17](https://github.com/sbb-design-systems/sbb-angular/commit/f4f7c171e3dc2d2b658bc227b77b81f38a6210a8))
* **deps:** update dependency tslib to v2.5.3 ([2a83cc2](https://github.com/sbb-design-systems/sbb-angular/commit/2a83cc2fe23dde37e5f3bcbcea8791313a99f531))
* **deps:** update dependency tslib to v2.6.0 ([4e324af](https://github.com/sbb-design-systems/sbb-angular/commit/4e324af9a768a1178176f7683e4d416c4a28f33b))
* **deps:** update dependency tslib to v2.6.1 ([506c82d](https://github.com/sbb-design-systems/sbb-angular/commit/506c82d0025f855fdbba2d49b4cef0c801580f0c))
* **deps:** update dependency tslib to v2.6.2 ([e962354](https://github.com/sbb-design-systems/sbb-angular/commit/e962354edc949b95f683964ead7d313de8ed31dc))
* **deps:** update dependency tslib to v2.6.3 (main) ([#2287](https://github.com/sbb-design-systems/sbb-angular/issues/2287)) ([2c89e73](https://github.com/sbb-design-systems/sbb-angular/commit/2c89e73bdc8bde1d9063d63acf8491e04902c69e))
* **deps:** update dependency tslib to v2.7.0 (main) ([#2343](https://github.com/sbb-design-systems/sbb-angular/issues/2343)) ([4e557f4](https://github.com/sbb-design-systems/sbb-angular/commit/4e557f478a96899fe8100a5a5ae14b93603d04ac))
* **deps:** update dependency tslib to v2.8.1 ([429c89e](https://github.com/sbb-design-systems/sbb-angular/commit/429c89efea731d95e03926757bfd6b86049d18be))
...
* **deps:** update dependency zone.js to v0.11.6 ([b8325ae](https://github.com/sbb-design-systems/sbb-angular/commit/b8325aee3ca2397bd913b5fd5388439e34d6f35c))
* **deps:** update dependency zone.js to v0.11.7 ([#1611](https://github.com/sbb-design-systems/sbb-angular/issues/1611)) ([06da9e1](https://github.com/sbb-design-systems/sbb-angular/commit/06da9e1bc26fd67ee160b4fbba9973d176488de1))
* **deps:** update dependency zone.js to v0.11.8 ([845842f](https://github.com/sbb-design-systems/sbb-angular/commit/845842f1aa904953729bd70893e7566c4d45804f))
* **deps:** update dependency zone.js to v0.12.0 ([29bbd4a](https://github.com/sbb-design-systems/sbb-angular/commit/29bbd4a4f4e75333ac2df28a5499dd0f5f870837))
* **deps:** update to angular 17.1.0 ([#2143](https://github.com/sbb-design-systems/sbb-angular/issues/2143)) ([ec86c89](https://github.com/sbb-design-systems/sbb-angular/commit/ec86c890854d54a3523052205905e200cfeace09)), closes [#2142](https://github.com/sbb-design-systems/sbb-angular/issues/2142)
...
* enforce @angular/cdk versions >= 17.1.0 ([#2144](https://github.com/sbb-design-systems/sbb-angular/issues/2144)) ([72c337e](https://github.com/sbb-design-systems/sbb-angular/commit/72c337ec5350603d73095e60feadd93c6c33541c))
...
* **esri-plugin:** fix stackblitz css detection ([#2216](https://github.com/sbb-design-systems/sbb-angular/issues/2216)) ([8699191](https://github.com/sbb-design-systems/sbb-angular/commit/8699191d552ef08e8151bc63ac78c87f15bb8f3b))
...
* **field:** fix missing css class ([#68](https://github.com/sbb-design-systems/sbb-angular/issues/68)) ([7400c83](https://github.com/sbb-design-systems/sbb-angular/commit/7400c83171771dc3e13bb8321c268d11ae036f8a))
* **file-selector:** fix upload with two way binding update ([#135](https://github.com/sbb-design-systems/sbb-angular/issues/135)) ([53de7b1](https://github.com/sbb-design-systems/sbb-angular/commit/53de7b19b1c12055771fdeb6926db6f95d32d263)), closes [#115](https://github.com/sbb-design-systems/sbb-angular/issues/115)
* fix change detection for sbb-processflow-step title ([#238](https://github.com/sbb-design-systems/sbb-angular/issues/238)) ([4cfc9e0](https://github.com/sbb-design-systems/sbb-angular/commit/4cfc9e0ea872525871f44fbccef1718fee1be70d))
...
* fix the disabled state of sbb-select ([#262](https://github.com/sbb-design-systems/sbb-angular/issues/262)) ([6f5c3e7](https://github.com/sbb-design-systems/sbb-angular/commit/6f5c3e77569e461eda5f548cdf6b7960338f479c)), closes [#244](https://github.com/sbb-design-systems/sbb-angular/issues/244)
* fix the overflow styling of usermenu ([#232](https://github.com/sbb-design-systems/sbb-angular/issues/232)) ([bac0c11](https://github.com/sbb-design-systems/sbb-angular/commit/bac0c115683730d78d07dd3a5be443df34b220f0)), closes [#164](https://github.com/sbb-design-systems/sbb-angular/issues/164) [#172](https://github.com/sbb-design-systems/sbb-angular/issues/172)
* fix the radio click with selected text ([#229](https://github.com/sbb-design-systems/sbb-angular/issues/229)) ([195a28d](https://github.com/sbb-design-systems/sbb-angular/commit/195a28d9c2ce92ed9a6373fda1e5e38ac5a7ab26)), closes [#222](https://github.com/sbb-design-systems/sbb-angular/issues/222)
...
* handle scrolling correctly ([#168](https://github.com/sbb-design-systems/sbb-angular/issues/168)) ([c9fa496](https://github.com/sbb-design-systems/sbb-angular/commit/c9fa496c20bd0415b5bf73ad705ee7a739cf18b0)), closes [#161](https://github.com/sbb-design-systems/sbb-angular/issues/161)
...
* **icons:** set focusable to false for svg icons ([#174](https://github.com/sbb-design-systems/sbb-angular/issues/174)) ([f19ef24](https://github.com/sbb-design-systems/sbb-angular/commit/f19ef24da3379e261a4c0ca257c86387b3e55630)), closes [#155](https://github.com/sbb-design-systems/sbb-angular/issues/155)
...
* **journey-maps:** acceptance test fixes ([#2160](https://github.com/sbb-design-systems/sbb-angular/issues/2160)) ([2af5f8b](https://github.com/sbb-design-systems/sbb-angular/commit/2af5f8b89f46fc0030839a0a89806a8615bd1262))
* **journey-maps:** adapt dark-mode for span in attribution ([#2162](https://github.com/sbb-design-systems/sbb-angular/issues/2162)) ([ec9e02f](https://github.com/sbb-design-systems/sbb-angular/commit/ec9e02fa1ea1d4b0c7507e60431804e7ef613492))
...
* **journey-maps:** allow showing default and custom 3d-buildings ... ([#2453](https://github.com/sbb-design-systems/sbb-angular/issues/2453)) ([3eb5775](https://github.com/sbb-design-systems/sbb-angular/commit/3eb57752eeffb571e8e35a561def45601b587df5))
...
* **journey-maps:** always broadcast rotation and pitch ([#2458](https://github.com/sbb-design-systems/sbb-angular/issues/2458)) ([1076291](https://github.com/sbb-design-systems/sbb-angular/commit/1076291919e60060fb8429bfb38331b9cd0924c1))
...
* **journey-maps:** changed POI V3 style default visibility to visible ([#2371](https://github.com/sbb-design-systems/sbb-angular/issues/2371)) ([24a00f5](https://github.com/sbb-design-systems/sbb-angular/commit/24a00f58777dea672409bbef4f1f51541ad80f17))
* **journey-maps:** delete unused files ([#2456](https://github.com/sbb-design-systems/sbb-angular/issues/2456)) ([9b7fd85](https://github.com/sbb-design-systems/sbb-angular/commit/9b7fd85d6545c68cbd70664a9efd435b0fc390a0))
...
* **journey-maps:** fix horizontal level switch animation ([#2210](https://github.com/sbb-design-systems/sbb-angular/issues/2210)) ([045ab1e](https://github.com/sbb-design-systems/sbb-angular/commit/045ab1ed3615fa14896d183b0d430b6dd796a170))
...
* **journey-maps:** fix popup triangle and aerial dark problems ([#2184](https://github.com/sbb-design-systems/sbb-angular/issues/2184)) ([2e3a45f](https://github.com/sbb-design-systems/sbb-angular/commit/2e3a45f8f4c69261341d9adc98ee20be5b7ac001))
* **journey-maps:** fix sonarlint issues ([#2183](https://github.com/sbb-design-systems/sbb-angular/issues/2183)) ([f466a99](https://github.com/sbb-design-systems/sbb-angular/commit/f466a99c9afe30aff2198172543a379c035b996b))
...
* **journey-maps:** handle route teaser interaction ([#2459](https://github.com/sbb-design-systems/sbb-angular/issues/2459)) ([5754bdc](https://github.com/sbb-design-systems/sbb-angular/commit/5754bdc021024e9820234210ee05192e1f173c3e))
...
* **journey-maps:** journey-pois category update ([#2375](https://github.com/sbb-design-systems/sbb-angular/issues/2375)) ([597b216](https://github.com/sbb-design-systems/sbb-angular/commit/597b216bec9c82f4ac876f3556cb3f03ec99dab0))
...
* **journey-maps:** manual change detection for web component ([#2356](https://github.com/sbb-design-systems/sbb-angular/issues/2356)) ([b5cce07](https://github.com/sbb-design-systems/sbb-angular/commit/b5cce07ad0a491bfd75955714ca0989d0823f558))
* **journey-maps:** prevent console errors ([#2093](https://github.com/sbb-design-systems/sbb-angular/issues/2093)) ([15242b1](https://github.com/sbb-design-systems/sbb-angular/commit/15242b10eb0cde563219782e3f530d6dde4cf83f))
...
* **journey-maps:** prevent opening side buttons on timeout ([#2166](https://github.com/sbb-design-systems/sbb-angular/issues/2166)) ([ed3212b](https://github.com/sbb-design-systems/sbb-angular/commit/ed3212bdcca511d71df9381cecb12606c7d8cab4))
* **journey-maps:** refresh pois after style change ([#2151](https://github.com/sbb-design-systems/sbb-angular/issues/2151)) ([fa01787](https://github.com/sbb-design-systems/sbb-angular/commit/fa01787f3905e4d6bef0821db6bac90272eb0b88))
...
* **journey-maps:** update test-data ([#2462](https://github.com/sbb-design-systems/sbb-angular/issues/2462)) ([27d32c9](https://github.com/sbb-design-systems/sbb-angular/commit/27d32c9b29d7c6799c07822cd94288bdd5d06507))
* **journey-maps:** use right color for disabled in dark-mode ([#2163](https://github.com/sbb-design-systems/sbb-angular/issues/2163)) ([8778433](https://github.com/sbb-design-systems/sbb-angular/commit/87784337e9c1a26c20aa5cfb165d00b8c61a64aa))
...
* **keycloak:** do not add authorization header on unauthenticated ([#101](https://github.com/sbb-design-systems/sbb-angular/issues/101)) ([040ab71](https://github.com/sbb-design-systems/sbb-angular/commit/040ab719b85c331c5d25df986915099e89e4f9cc)), closes [#95](https://github.com/sbb-design-systems/sbb-angular/issues/95)
* **keycloak:** fixes wrong package name in README ([#63](https://github.com/sbb-design-systems/sbb-angular/issues/63)) ([d2846ad](https://github.com/sbb-design-systems/sbb-angular/commit/d2846ad0da9892dce836237be48b1db34cf811fb))
...
* limit header icon height to header height ([#237](https://github.com/sbb-design-systems/sbb-angular/issues/237)) ([633f05a](https://github.com/sbb-design-systems/sbb-angular/commit/633f05a7ad02ad80734af512fbe74f93fc392910)), closes [#204](https://github.com/sbb-design-systems/sbb-angular/issues/204)
* limit sbb-select dropdown width to host ([#239](https://github.com/sbb-design-systems/sbb-angular/issues/239)) ([847fcc4](https://github.com/sbb-design-systems/sbb-angular/commit/847fcc4183be0143cd3ebff6bc442bdafd61cddb)), closes [#220](https://github.com/sbb-design-systems/sbb-angular/issues/220)
* make notification component jump marks fault tolerant ([3ffdf4a](https://github.com/sbb-design-systems/sbb-angular/commit/3ffdf4af5ddaa5ecb8f122738bf07bdf64ef0cce))
...
* **multiple:** account for mixed declarations in latest Sass version ([#2392](https://github.com/sbb-design-systems/sbb-angular/issues/2392)) ([c291d59](https://github.com/sbb-design-systems/sbb-angular/commit/c291d59724b0dd519229d21fb44d01c35c6ac10f))
...
* **multiple:** change dark mode background to midnight and fix some styles ([#2081](https://github.com/sbb-design-systems/sbb-angular/issues/2081)) ([798be0a](https://github.com/sbb-design-systems/sbb-angular/commit/798be0a00047c9cfc7c84d5ca22208b2becaa7ec))
...
* **multiple:** import ANIMATION_MODULE_TYPE from core ([#2161](https://github.com/sbb-design-systems/sbb-angular/issues/2161)) ([fa580cc](https://github.com/sbb-design-systems/sbb-angular/commit/fa580cc739ae15760937aae0f9f3ead76a4f1b91))
* **multiple:** remove label for attribute on non-native elements ([#2258](https://github.com/sbb-design-systems/sbb-angular/issues/2258)) ([1032655](https://github.com/sbb-design-systems/sbb-angular/commit/1032655446431784baaa23f50bb5e42c8aaadaca)), closes [#1918](https://github.com/sbb-design-systems/sbb-angular/issues/1918)
...
* **multiple:** remove usages of Sass globals ([#2424](https://github.com/sbb-design-systems/sbb-angular/issues/2424)) ([684e27e](https://github.com/sbb-design-systems/sbb-angular/commit/684e27e8436d091f5ff6812fdbbff69cdd6a7bc3))
...
* normalized radio button behavior ([#183](https://github.com/sbb-design-systems/sbb-angular/issues/183)) ([ec0a25e](https://github.com/sbb-design-systems/sbb-angular/commit/ec0a25ef51896c358a8b486fbdc24e6d5778c744)), closes [#126](https://github.com/sbb-design-systems/sbb-angular/issues/126)
...
* on error display sbb-select with red color and border ([#233](https://github.com/sbb-design-systems/sbb-angular/issues/233)) ([7214487](https://github.com/sbb-design-systems/sbb-angular/commit/72144877a016acdbca3e5630c64003736d70aabb))
...
* **pagination:** fixes pagination focus issues ([#54](https://github.com/sbb-design-systems/sbb-angular/issues/54)) ([1e1ce4b](https://github.com/sbb-design-systems/sbb-angular/commit/1e1ce4be27e2d276b0bb46a1750649f73fad8453)), closes [#17](https://github.com/sbb-design-systems/sbb-angular/issues/17)
...
* **processflow:** fixes click behavior for future steps ([#57](https://github.com/sbb-design-systems/sbb-angular/issues/57)) ([2e37b4a](https://github.com/sbb-design-systems/sbb-angular/commit/2e37b4ab81471a633a5283f25de72e5fedeed987))
* **public/ghettobox:** correct line-height for icons ([#117](https://github.com/sbb-design-systems/sbb-angular/issues/117)) ([038185a](https://github.com/sbb-design-systems/sbb-angular/commit/038185a7138c2bb0c876a930d6c7c318ccafc7a3))
...
* **public:** correct dropdown width in breadcrumbs ([#278](https://github.com/sbb-design-systems/sbb-angular/issues/278)) ([f4019cf](https://github.com/sbb-design-systems/sbb-angular/commit/f4019cf3186ba39826be6f39a043197d6535cfa7)), closes [#268](https://github.com/sbb-design-systems/sbb-angular/issues/268)
...
* **public:** fix the sticky detection for public table ([#250](https://github.com/sbb-design-systems/sbb-angular/issues/250)) ([84b5241](https://github.com/sbb-design-systems/sbb-angular/commit/84b5241433b4076ca7c4fcf6b935221547a34be6)), closes [#247](https://github.com/sbb-design-systems/sbb-angular/issues/247)
...
* relax amount of tabs check ([#230](https://github.com/sbb-design-systems/sbb-angular/issues/230)) ([d5f367b](https://github.com/sbb-design-systems/sbb-angular/commit/d5f367be536539cd6df5e93d8fa462d5caecc9d8))
* remove aria-owns to prevent Chrome crash ([#2242](https://github.com/sbb-design-systems/sbb-angular/issues/2242)) ([bfe3266](https://github.com/sbb-design-systems/sbb-angular/commit/bfe326617fecca8c48eda9f62b93d8c14cad9a57))
* remove autogenerated from business components html ([6f7b00e](https://github.com/sbb-design-systems/sbb-angular/commit/6f7b00ef2614a1fb25a0d9cd7c742318174c182a))
...
* **sbb-journey-maps:** let finger tip on mobile be dismissible ([#2056](https://github.com/sbb-design-systems/sbb-angular/issues/2056)) ([5ce3fe6](https://github.com/sbb-design-systems/sbb-angular/commit/5ce3fe6d05f1be36d589246942c9aa5295aef1b3))
...
* **select:** change arrow trigger position to absolute ([#60](https://github.com/sbb-design-systems/sbb-angular/issues/60)) ([92512c2](https://github.com/sbb-design-systems/sbb-angular/commit/92512c235ff38b71b39fdeddf3f95999d8553a9e))
* **select:** fix native select icon in ie ([#105](https://github.com/sbb-design-systems/sbb-angular/issues/105)) ([cdbcb75](https://github.com/sbb-design-systems/sbb-angular/commit/cdbcb757628e6e5ff191e29c97927e4893a8a0b5)), closes [#102](https://github.com/sbb-design-systems/sbb-angular/issues/102)
...
* set min size for radio button and checkbox icon ([#231](https://github.com/sbb-design-systems/sbb-angular/issues/231)) ([20037b4](https://github.com/sbb-design-systems/sbb-angular/commit/20037b4c8d5b9dd3925651a26e709be8b4812ceb)), closes [#141](https://github.com/sbb-design-systems/sbb-angular/issues/141)
...
* **showcase:** catch error if showcase component ha no examples ([#276](https://github.com/sbb-design-systems/sbb-angular/issues/276)) ([7379078](https://github.com/sbb-design-systems/sbb-angular/commit/73790782c43ee51be082f5bf5c465e58faaacf61))
* **showcase:** correct import from [@angular](https://github.com/angular) to [@sbb-esta](https://github.com/sbb-esta) ([#180](https://github.com/sbb-design-systems/sbb-angular/issues/180)) ([fac7916](https://github.com/sbb-design-systems/sbb-angular/commit/fac7916716d8e9c98d4fbd861beb67edd54e88d9))
...
* **showcase:** fix code formatting ([dfdb037](https://github.com/sbb-design-systems/sbb-angular/commit/dfdb037483fb961ea73606d74c8dbdaa9a3d9257))
...
* **showcase:** fix example code loading ([#167](https://github.com/sbb-design-systems/sbb-angular/issues/167)) ([2e85d3d](https://github.com/sbb-design-systems/sbb-angular/commit/2e85d3d03e82e83f27be9383ec338032d573aac0)), closes [#165](https://github.com/sbb-design-systems/sbb-angular/issues/165)
...
* **showcase:** fix position of header menu hint ([6347200](https://github.com/sbb-design-systems/sbb-angular/commit/6347200a8ce1043cc475bba973b22d23e4552ddd))
...
* **showcase:** improve styles in examples ([#304](https://github.com/sbb-design-systems/sbb-angular/issues/304)) ([9dff0bf](https://github.com/sbb-design-systems/sbb-angular/commit/9dff0bf9b05bbc85aed1f99a43583752807a411d))
* **showcase:** make expandable table example working on all browsers ([#2101](https://github.com/sbb-design-systems/sbb-angular/issues/2101)) ([5dc697c](https://github.com/sbb-design-systems/sbb-angular/commit/5dc697cdcc9c87503893b256ce35cf88c4d747b4)), closes [#2100](https://github.com/sbb-design-systems/sbb-angular/issues/2100)
* **showcase:** remove duplicate introduction link ([fee613b](https://github.com/sbb-design-systems/sbb-angular/commit/fee613bac7940ab2e4614bd5b70ae69c73cd015e))
...
* **stackblitz:** update stackblitz assets ([#2155](https://github.com/sbb-design-systems/sbb-angular/issues/2155)) ([1f5a117](https://github.com/sbb-design-systems/sbb-angular/commit/1f5a1174097e4cae884a01816afe64235b1c8257))
...
* **table:** documents ie11 limitation of pinMode ([#64](https://github.com/sbb-design-systems/sbb-angular/issues/64)) ([f232240](https://github.com/sbb-design-systems/sbb-angular/commit/f232240badfc76bc0641c8c97c65500f9e228a7b)), closes [#58](https://github.com/sbb-design-systems/sbb-angular/issues/58)
* **table:** fix align helper classes for .sbb-table ([#113](https://github.com/sbb-design-systems/sbb-angular/issues/113)) ([fad4627](https://github.com/sbb-design-systems/sbb-angular/commit/fad462749c5f17b3a6d6c3f6fd2175735a07522e)), closes [#112](https://github.com/sbb-design-systems/sbb-angular/issues/112)
* **table:** fix tableAlignment for table headers in IE11 ([#133](https://github.com/sbb-design-systems/sbb-angular/issues/133)) ([1e5b950](https://github.com/sbb-design-systems/sbb-angular/commit/1e5b950070fdced262c1a370142a34bd159f76ad)), closes [#122](https://github.com/sbb-design-systems/sbb-angular/issues/122)
* **table:** fixes even row styling ([#48](https://github.com/sbb-design-systems/sbb-angular/issues/48)) ([227da9b](https://github.com/sbb-design-systems/sbb-angular/commit/227da9b6df4fc67ca795c3198cd73b090659b91d)), closes [#29](https://github.com/sbb-design-systems/sbb-angular/issues/29)
* **table:** pinMode fails gracefully on ie ([#94](https://github.com/sbb-design-systems/sbb-angular/issues/94)) ([75420e9](https://github.com/sbb-design-systems/sbb-angular/commit/75420e9814517ea2199e1ce4bec12d35fbbe0c82)), closes [#58](https://github.com/sbb-design-systems/sbb-angular/issues/58)
* **table:** show pin mode shadow with OnPush change detection ([#179](https://github.com/sbb-design-systems/sbb-angular/issues/179)) ([d97749a](https://github.com/sbb-design-systems/sbb-angular/commit/d97749a147064c0a4c1e16c9a662de8fd3c7ae1a)), closes [#177](https://github.com/sbb-design-systems/sbb-angular/issues/177)
* **textarea:** fix textarea update issue ([#107](https://github.com/sbb-design-systems/sbb-angular/issues/107)) ([103923f](https://github.com/sbb-design-systems/sbb-angular/commit/103923f341f0b65cc88edabf16e964f1b4754cd5)), closes [#106](https://github.com/sbb-design-systems/sbb-angular/issues/106)
* **textarea:** fixes no-wrap issue in edge ([#62](https://github.com/sbb-design-systems/sbb-angular/issues/62)) ([87c4db6](https://github.com/sbb-design-systems/sbb-angular/commit/87c4db620d50effc445c13884df508b7bc3a133d)), closes [#16](https://github.com/sbb-design-systems/sbb-angular/issues/16)
* **textarea:** fixes placeholder issue and sizing behavior ([#44](https://github.com/sbb-design-systems/sbb-angular/issues/44)) ([8a87e6e](https://github.com/sbb-design-systems/sbb-angular/commit/8a87e6ec74f45c0b44b43ff12cef89dae7edd05e)), closes [#16](https://github.com/sbb-design-systems/sbb-angular/issues/16)
* **textarea:** trigger calculation of remaining characters correctly ([#252](https://github.com/sbb-design-systems/sbb-angular/issues/252)) ([e3916dd](https://github.com/sbb-design-systems/sbb-angular/commit/e3916dd59d09d7959dd19d3b4180fc169c18c419)), closes [#217](https://github.com/sbb-design-systems/sbb-angular/issues/217)
...
* **toggle:** accept initial value for state ([#130](https://github.com/sbb-design-systems/sbb-angular/issues/130)) ([1851c94](https://github.com/sbb-design-systems/sbb-angular/commit/1851c943cbf59fa9c1b9f3acd6c5bf9b2ee7b5ee)), closes [#120](https://github.com/sbb-design-systems/sbb-angular/issues/120)
* **toggle:** fire toggleChange only when status actually changes ([#137](https://github.com/sbb-design-systems/sbb-angular/issues/137)) ([5b4c8a5](https://github.com/sbb-design-systems/sbb-angular/commit/5b4c8a5248f4cae56af342f63a65272a9c3817ca)), closes [#136](https://github.com/sbb-design-systems/sbb-angular/issues/136)
* **toggle:** use for-loop in place of forEach on NodeList ([#134](https://github.com/sbb-design-systems/sbb-angular/issues/134)) ([494d46b](https://github.com/sbb-design-systems/sbb-angular/commit/494d46b04eb987ca74e7a0fc50fde7e2d439c666)), closes [#125](https://github.com/sbb-design-systems/sbb-angular/issues/125)
* tooltip positioning is now inside the viewport ([#181](https://github.com/sbb-design-systems/sbb-angular/issues/181)) ([dd5ba09](https://github.com/sbb-design-systems/sbb-angular/commit/dd5ba099b430977cddf0764011353b7786ca9490)), closes [#176](https://github.com/sbb-design-systems/sbb-angular/issues/176)
...
* trying to fix the build ([a0344d8](https://github.com/sbb-design-systems/sbb-angular/commit/a0344d872efbd1722db9187c38eafaefc793b4bc))
* **typography:** fix font-size for fieldset 4k and 5k ([#71](https://github.com/sbb-design-systems/sbb-angular/issues/71)) ([e1d6808](https://github.com/sbb-design-systems/sbb-angular/commit/e1d68082017795c8c0066d7857694e7de0260725))
...
* update schematics for v18 ([#2280](https://github.com/sbb-design-systems/sbb-angular/issues/2280)) ([b539a26](https://github.com/sbb-design-systems/sbb-angular/commit/b539a26ca6407f3188f82b9f90b288dd9ccc14ae))
...
* use the correct SBB fonts ([#260](https://github.com/sbb-design-systems/sbb-angular/issues/260)) ([bb18668](https://github.com/sbb-design-systems/sbb-angular/commit/bb1866889adeba5ca7af388d5b792caaf1e4a625))
...
* **usermenu:** fix arrow overlap ([#138](https://github.com/sbb-design-systems/sbb-angular/issues/138)) ([cd99723](https://github.com/sbb-design-systems/sbb-angular/commit/cd997234747d21c980c00a6400682b460ff18854)), closes [#132](https://github.com/sbb-design-systems/sbb-angular/issues/132)
* **usermenu:** fix layout after click ([#128](https://github.com/sbb-design-systems/sbb-angular/issues/128)) ([21dd37c](https://github.com/sbb-design-systems/sbb-angular/commit/21dd37c4ac2d603c2795ec623543569f4f15e5e2)), closes [#124](https://github.com/sbb-design-systems/sbb-angular/issues/124)
...
* adapt Accordion documentation to correctly reflect the multi input ([#354](https://github.com/sbb-design-systems/sbb-angular/issues/354)) ([3f4837d](https://github.com/sbb-design-systems/sbb-angular/commit/3f4837d0fd82596962df0c8281f5a0d95aaf950c))
* add `npm install @sbb-esta/angular-core` to readme ([#299](https://github.com/sbb-design-systems/sbb-angular/issues/299)) ([14baa0c](https://github.com/sbb-design-systems/sbb-angular/commit/14baa0c061c6b44b91c7f8d29ae288b77f412b96))
...
* add browser stack icon ([#236](https://github.com/sbb-design-systems/sbb-angular/issues/236)) ([65c878a](https://github.com/sbb-design-systems/sbb-angular/commit/65c878a91157e730158c24bc3823d30c2e8f1627)), closes [#235](https://github.com/sbb-design-systems/sbb-angular/issues/235)
* add code of conduct ([1d7de22](https://github.com/sbb-design-systems/sbb-angular/commit/1d7de22b4f7e99d625a190f5aca49b5b2f1d8567))
* add contribution guidelines ([#8](https://github.com/sbb-design-systems/sbb-angular/issues/8)) ([edb7654](https://github.com/sbb-design-systems/sbb-angular/commit/edb7654e4440cd451e92b804663fdeeaf086fe64)), closes [#4](https://github.com/sbb-design-systems/sbb-angular/issues/4)
...
* add details to merge documentation ([#699](https://github.com/sbb-design-systems/sbb-angular/issues/699)) ([527c191](https://github.com/sbb-design-systems/sbb-angular/commit/527c191aab27a8f3580039c44debc8a8d141ff1e))
...
* add header to menu ([0b6cbad](https://github.com/sbb-design-systems/sbb-angular/commit/0b6cbad7a0193a3ee61e0c9abf0af4aed138b6fb))
...
* add update steps for version 20 ([#2561](https://github.com/sbb-design-systems/sbb-angular/issues/2561)) ([9d0e475](https://github.com/sbb-design-systems/sbb-angular/commit/9d0e475d84b53bdc579c51808724b7823a6ef5eb))
...
* **angular/accordion:** update accordion examples ([#2317](https://github.com/sbb-design-systems/sbb-angular/issues/2317)) ([ff49304](https://github.com/sbb-design-systems/sbb-angular/commit/ff49304e081394f00d7b83ba8c5bce346265f8b7))
* **angular/autocomplete:** add guidance for scroll event handling ([#2612](https://github.com/sbb-design-systems/sbb-angular/issues/2612)) ([ac4a19c](https://github.com/sbb-design-systems/sbb-angular/commit/ac4a19c17f6d871ef44d40cf5369cf6b53249c20)), closes [#2574](https://github.com/sbb-design-systems/sbb-angular/issues/2574)
...
* **angular/dialog:** update dialog examples ([#2316](https://github.com/sbb-design-systems/sbb-angular/issues/2316)) ([fb24464](https://github.com/sbb-design-systems/sbb-angular/commit/fb24464d49380d6b0d8fd981ec0597fd7b05ebbb))
* **angular/icon:** update icon example ([#2320](https://github.com/sbb-design-systems/sbb-angular/issues/2320)) ([786b412](https://github.com/sbb-design-systems/sbb-angular/commit/786b4120f6f10697d92d67d9d26bc0020991887c))
...
* **angular/toggle:** update toggle examples ([#2318](https://github.com/sbb-design-systems/sbb-angular/issues/2318)) ([90fe639](https://github.com/sbb-design-systems/sbb-angular/commit/90fe6397aeb3148196c087ec8ede5249c7ff45bd))
...
* autocomplete example in table filtering ([#451](https://github.com/sbb-design-systems/sbb-angular/issues/451)) ([4057224](https://github.com/sbb-design-systems/sbb-angular/commit/4057224935cd63acf1bf0a063a466d520517cad4))
* **business:** add hint for required pagination module to table ([#601](https://github.com/sbb-design-systems/sbb-angular/issues/601)) ([eff14b0](https://github.com/sbb-design-systems/sbb-angular/commit/eff14b0c29c41413369aeab15c82a69a0e521fba))
...
* change GitHub address ([53a7744](https://github.com/sbb-design-systems/sbb-angular/commit/53a7744906177d0584e16f401b47626f445b24e3))
* change name of schematics for generating icons ([#270](https://github.com/sbb-design-systems/sbb-angular/issues/270)) ([2d6b836](https://github.com/sbb-design-systems/sbb-angular/commit/2d6b8366c04009e5f787cb7695d7b79ebe98835d))
* clarify public vs business ([#482](https://github.com/sbb-design-systems/sbb-angular/issues/482)) ([e507501](https://github.com/sbb-design-systems/sbb-angular/commit/e5075010fd3bdd69216cb4893d6f0e18553cc238))
...
* **core:** update breakpoints documentation ([#597](https://github.com/sbb-design-systems/sbb-angular/issues/597)) ([a14c4f2](https://github.com/sbb-design-systems/sbb-angular/commit/a14c4f2aa7263c5a2415617dd906052bcb850c43))
* correct see below to seen below ([#762](https://github.com/sbb-design-systems/sbb-angular/issues/762)) ([f09b115](https://github.com/sbb-design-systems/sbb-angular/commit/f09b115e2424cc30b00e9b3b3b723f0161fb2a5b))
* define coding standards ([#609](https://github.com/sbb-design-systems/sbb-angular/issues/609)) ([1b2ed36](https://github.com/sbb-design-systems/sbb-angular/commit/1b2ed361b3c15e85ace02d61aaeff956c11516e8))
...
* document how to do merge migrations ([4b24cc9](https://github.com/sbb-design-systems/sbb-angular/commit/4b24cc9cbc464ee241741228a3719ed46833963e))
* document TypeRef ([#524](https://github.com/sbb-design-systems/sbb-angular/issues/524)) ([a05a9b1](https://github.com/sbb-design-systems/sbb-angular/commit/a05a9b151547d02a01c88ccfe34d1bae5862e584))
...
* extend MERGE_MIGRATION ([3df366f](https://github.com/sbb-design-systems/sbb-angular/commit/3df366ff8d9ec66ad9befce24c38f6c81010b995))
* fix generating docs and improve deprecated styling ([#391](https://github.com/sbb-design-systems/sbb-angular/issues/391)) ([456b0fc](https://github.com/sbb-design-systems/sbb-angular/commit/456b0fcf935d3e1265caa0edda90f71f83eb9615))
* fix header documentation ([9d13e03](https://github.com/sbb-design-systems/sbb-angular/commit/9d13e03570a913b745d1da3b9dbe4d80cbbf4a35))
* fix icon list link in readme ([dfd583b](https://github.com/sbb-design-systems/sbb-angular/commit/dfd583ba838128738470f43e58c6555f5b0e5a57))
* fix package name in readme ([4ce090e](https://github.com/sbb-design-systems/sbb-angular/commit/4ce090e365f409380d1d71b2fe2ec9023606a03c))
...
* fix stackblitz and update assets ([#2297](https://github.com/sbb-design-systems/sbb-angular/issues/2297)) ([96ae3f8](https://github.com/sbb-design-systems/sbb-angular/commit/96ae3f86f3ce722a5dbe36a3dd1035cf1f42b855))
...
* highlight bazel files schematics ([#389](https://github.com/sbb-design-systems/sbb-angular/issues/389)) ([764b51c](https://github.com/sbb-design-systems/sbb-angular/commit/764b51cc1290bb0b8508cd5b0c2588f7b24735d2))
...
* how to update guide ([#475](https://github.com/sbb-design-systems/sbb-angular/issues/475)) ([d2c1ce5](https://github.com/sbb-design-systems/sbb-angular/commit/d2c1ce538ca722133067378175e6b913a629a952))
...
* **journey-maps:** add documentation for 'isLevelSwitchHorizontal' ([#2457](https://github.com/sbb-design-systems/sbb-angular/issues/2457)) ([0fd3537](https://github.com/sbb-design-systems/sbb-angular/commit/0fd353716960b06cce3260bfb67ce0f159888108))
* **journey-maps:** add footway example for journey routes ([#2511](https://github.com/sbb-design-systems/sbb-angular/issues/2511)) ([ccf635d](https://github.com/sbb-design-systems/sbb-angular/commit/ccf635d3632e03768ce320c3b8c6f1a5e6d10280))
...
* **journey-maps:** add several new examples for journey maps client ([#2217](https://github.com/sbb-design-systems/sbb-angular/issues/2217)) ([4e56af6](https://github.com/sbb-design-systems/sbb-angular/commit/4e56af69e91bf8d43ff59fdf137b9910c0046af0))
...
* **journey-maps:** include extra files ([#2452](https://github.com/sbb-design-systems/sbb-angular/issues/2452)) ([54adb88](https://github.com/sbb-design-systems/sbb-angular/commit/54adb88538695279e343467c88c45e354744f568))
* **journey-maps:** removed unused props in example ([#2354](https://github.com/sbb-design-systems/sbb-angular/issues/2354)) ([0afcb6e](https://github.com/sbb-design-systems/sbb-angular/commit/0afcb6e4dcbbc551b487279f9745c3e49e23c3c9))
...
* **journey-maps:** usage example for map.selectedLevel ([#2370](https://github.com/sbb-design-systems/sbb-angular/issues/2370)) ([a61fa86](https://github.com/sbb-design-systems/sbb-angular/commit/a61fa864588ab577f93aec8f213d7f8a1df32b9d))
* **keycloak:** fix typo ([#582](https://github.com/sbb-design-systems/sbb-angular/issues/582)) ([e8d65e9](https://github.com/sbb-design-systems/sbb-angular/commit/e8d65e9791aa00873048fe6efa4932fa03e02dd4))
* **keycloak:** recommend angular-oauth2-oidc ([#301](https://github.com/sbb-design-systems/sbb-angular/issues/301)) ([d4b7c2c](https://github.com/sbb-design-systems/sbb-angular/commit/d4b7c2c2d48d154b637ea67bd848685f1e865ab7))
* let table selection example use filteredData instead of data ([#427](https://github.com/sbb-design-systems/sbb-angular/issues/427)) ([9bcbe49](https://github.com/sbb-design-systems/sbb-angular/commit/9bcbe497060732b36519e37368a99f597c23a6c7))
...
* **maps:** add detailed CORS support explanation ([#578](https://github.com/sbb-design-systems/sbb-angular/issues/578)) ([c59e2e3](https://github.com/sbb-design-systems/sbb-angular/commit/c59e2e30794e8c293e84c42f782648a9be922759))
* **maps:** fix parameter name for angular-maps ([#324](https://github.com/sbb-design-systems/sbb-angular/issues/324)) ([3a6f9f8](https://github.com/sbb-design-systems/sbb-angular/commit/3a6f9f8b54ace56aaf5d0685112c028072dbbde8))
* **maps:** fix typo ([#580](https://github.com/sbb-design-systems/sbb-angular/issues/580)) ([57d3ff6](https://github.com/sbb-design-systems/sbb-angular/commit/57d3ff6e6c68ca5c72416960f182d9ea90b95893))
...
* migrate selectors to self-closing tags to align with Angular style ([#2637](https://github.com/sbb-design-systems/sbb-angular/issues/2637)) ([d4da185](https://github.com/sbb-design-systems/sbb-angular/commit/d4da1852fff02f54481a3af620c59d3551240560))
...
* recommend US English as default language ([#425](https://github.com/sbb-design-systems/sbb-angular/issues/425)) ([2265897](https://github.com/sbb-design-systems/sbb-angular/commit/2265897381ba724944ba2db9b5906cf90be3ed59))
...
* remove Oauth documentation part ([#2286](https://github.com/sbb-design-systems/sbb-angular/issues/2286)) ([e0921f8](https://github.com/sbb-design-systems/sbb-angular/commit/e0921f88cc0b70feae372357c7a8fdc1b8232abf))
* remove reverted angular-maps change from changelog ([754ea5e](https://github.com/sbb-design-systems/sbb-angular/commit/754ea5e08d938e9fb38b6d2d4940ea445a496e18))
* remove standalone flag from examples ([#2415](https://github.com/sbb-design-systems/sbb-angular/issues/2415)) ([3eee7bd](https://github.com/sbb-design-systems/sbb-angular/commit/3eee7bdfd0a200449d7183f7e319131088e46e5a))
...
* switch examples to use inject ([#2366](https://github.com/sbb-design-systems/sbb-angular/issues/2366)) ([309f136](https://github.com/sbb-design-systems/sbb-angular/commit/309f136fbda0db6eedbc1900370ceb34a4d6a00d))
* update changelog ([56e8f91](https://github.com/sbb-design-systems/sbb-angular/commit/56e8f913da78b56019cc9480d7526bfa0e54d6d3))
...
* update documentation for journey maps web component ([#2568](https://github.com/sbb-design-systems/sbb-angular/issues/2568)) ([cbd0898](https://github.com/sbb-design-systems/sbb-angular/commit/cbd0898e5154e677cfc0853bc0184549d71e23a1))
* update documentation for pagination ([#111](https://github.com/sbb-design-systems/sbb-angular/issues/111)) ([f97d99e](https://github.com/sbb-design-systems/sbb-angular/commit/f97d99e6154eb96dace364ff4252d2f517348184))
* update header documentation ([a2b8aaa](https://github.com/sbb-design-systems/sbb-angular/commit/a2b8aaaa08b15ab91a59690283d13e0b8369a309))
...
* update links to digital.sbb.ch ([#2284](https://github.com/sbb-design-systems/sbb-angular/issues/2284)) ([257cb08](https://github.com/sbb-design-systems/sbb-angular/commit/257cb08b13740dc6ed8d5ec401fb1d1422d58e96))
...
* update merge migration with usages check step ([#702](https://github.com/sbb-design-systems/sbb-angular/issues/702)) ([22b9643](https://github.com/sbb-design-systems/sbb-angular/commit/22b9643c435391f4b88f589b98d71608325e9a6f))
...
* use correct package display name ([#430](https://github.com/sbb-design-systems/sbb-angular/issues/430)) ([343c8dc](https://github.com/sbb-design-systems/sbb-angular/commit/343c8dcd19d2ae532a8ed3f26a26a3ba0e2937ba))
