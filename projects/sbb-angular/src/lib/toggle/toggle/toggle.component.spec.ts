...
@Component({
  ...
  template: `<form [formGroup]="form" novalidate>
                    <sbb-toggle aria-labelledby="group_label_2" formControlName="test">
                        <sbb-toggle-option #options *ngFor="let option of toggleOptions | async; let i = index;"
...
@Component({
  ...
  template: `<sbb-toggle aria-labelledby="group_label_1"
                         [(ngModel)]="modelValue"
                         name="test-toggle-2">
...
describe('ToggleComponent case reactive using mock component', () => {
  ...
  it('it verifies that first toggle button is checked', () => {
    ...
    const toggleOptionReferenceValue = fixtureTest
      .debugElement
      .queryAll(By.css('.sbb-toggle-option-button-inner > input'));
  ...
  it('it verifies the click on the second toggle option selected ', () => {
    ...
    const toggleOptionsInputReference = fixtureTest
      .debugElement
      .queryAll(By.css('.sbb-toggle-option input'));
    ...
    expect(toggleOption2Component.attributes['class'].value).toContain('sbb-toggle-option-selected');
  ...
  it('it verifies the text content into a toggle button to click on another toggle button', () => {
    ...
    const toggleOptionsContentReference = fixtureTest
      .debugElement
      .queryAll(By.css('.sbb-toggle-option > label > div > span > .sbb-toggle-option-button-info-text '));
...
describe('ToggleComponent case template driven using mock component', () => {
  ...
  it('it verifies if the first toggle option is selected ', () => {
    ...
    const toggleOption1ReferenceValue = fixtureTest
      .debugElement
      .queryAll(By.css('.sbb-toggle-option-button-inner > input'));
  ...
  it('it verifies the click on the second toggle option selected ', () => {
    ...
    const toggleOptionsComponent = fixtureTest
      .debugElement
      .queryAll(By.css('.sbb-toggle-option'));
