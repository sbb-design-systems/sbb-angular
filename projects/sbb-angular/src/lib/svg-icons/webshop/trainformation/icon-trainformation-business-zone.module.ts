...
@NgModule({
  declarations: [IconTrainformationBusinessZoneComponent],
  exports: [IconTrainformationBusinessZoneComponent],
})
export class IconTrainformationBusinessZoneModule { }
