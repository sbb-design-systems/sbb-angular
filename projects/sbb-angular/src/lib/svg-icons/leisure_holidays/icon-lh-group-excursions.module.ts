...
@NgModule({
  declarations: [IconLhGroupExcursionsComponent],
  exports: [IconLhGroupExcursionsComponent],
})
export class IconLhGroupExcursionsModule { }
