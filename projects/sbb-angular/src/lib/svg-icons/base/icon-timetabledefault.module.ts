...
@NgModule({
  declarations: [IconTimetabledefaultComponent],
  exports: [IconTimetabledefaultComponent],
})
export class IconTimetabledefaultModule { }
