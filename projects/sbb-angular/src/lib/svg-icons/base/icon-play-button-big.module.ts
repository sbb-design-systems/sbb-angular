...
@Component({
  ...
  template: `<svg [attr.class]="'sbb-svg-icon ' + svgClass" [attr.viewBox]="viewBox" [attr.preserveAspectRatio]="preserveAspectRatio" [attr.width]="width" [attr.height]="height" xmlns="http://www.w3.org/2000/svg"><path fill="#FFF" fill-rule="evenodd" d="M.116 2.753C.116.546 1.664-.335 3.56.777l11.09 6.5c1.902 1.116 1.864 2.87-.076 3.916l-10.94 5.89c-1.943 1.048-3.518.102-3.518-2.1V2.754z"/></svg>`,
