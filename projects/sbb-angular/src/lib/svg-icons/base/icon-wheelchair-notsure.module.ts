...
@NgModule({
  declarations: [IconWheelchairNotsureComponent],
  exports: [IconWheelchairNotsureComponent],
})
export class IconWheelchairNotsureModule { }
