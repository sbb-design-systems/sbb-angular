...
@NgModule({
  declarations: [IconWheelchairDisabledComponent],
  exports: [IconWheelchairDisabledComponent],
})
export class IconWheelchairDisabledModule { }
