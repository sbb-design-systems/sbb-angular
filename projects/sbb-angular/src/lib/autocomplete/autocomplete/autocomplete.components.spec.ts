...
describe('AutocompleteComponent', () => {
    ...
    describe('panel toggling', () => {
        ...
        it('should open the panel when the input is focused', () => {
            ...
            expect(overlayContainerElement.textContent)
                .toContain('Eins', `Expected panel to display when input is focused.`);
            expect(overlayContainerElement.textContent)
                .toContain('Zwei', `Expected panel to display when input is focused.`);
        });
        ...
        it('should open the panel programmatically', () => {
            ...
            expect(overlayContainerElement.textContent)
                .toContain('Eins', `Expected panel to display when opened programmatically.`);
            expect(overlayContainerElement.textContent)
                .toContain('Zwei', `Expected panel to display when opened programmatically.`);
        });
        ...
        it('should hide the panel when the options list is empty', fakeAsync(() => {
            ...
            expect(panel.classList)
                .toContain('sbb-autocomplete-visible', `Expected panel to start out visible.`);
            ...
            expect(panel.classList)
                .toContain('sbb-autocomplete-hidden', `Expected panel to hide itself when empty.`);
        }));
    ...
    describe('forms integration', () => {
        ...
        it('should fill the text field with display value when an option is selected', fakeAsync(() => {
            ...
            expect(input.value)
                .toContain('Zwei', `Expected text field to fill with selected value.`);
        }));

        it('should fill the text field correctly if value is set to obj programmatically',
            fakeAsync(() => {
                fixture.componentInstance.numberCtrl.setValue({ code: '1', name: 'Eins' });
                fixture.detectChanges();
                tick();
                fixture.detectChanges();

                expect(input.value)
                    .toContain('Eins', `Expected input to fill with matching option's viewValue.`);
            }));
    ...
    describe('keyboard events', () => {
        ...
        it('should not close the panel when DOWN key is pressed', () => {
            ...
            expect(overlayContainerElement.textContent)
                .toContain('Eins', `Expected panel to keep displaying when DOWN key is pressed.`);
            expect(overlayContainerElement.textContent)
                .toContain('Zwei', `Expected panel to keep displaying when DOWN key is pressed.`);
        });
        ...
        it('should open the panel again when typing after making a selection', fakeAsync(() => {
            ...
            expect(overlayContainerElement.textContent)
                .toContain('Eins', `Expected panel to display when typing in input.`);
        }));
    ...
    it('should emit an event when an option is selected', fakeAsync(() => {
        ...
        const options = overlayContainerElement.querySelectorAll('sbb-option') as NodeListOf<HTMLElement>;
