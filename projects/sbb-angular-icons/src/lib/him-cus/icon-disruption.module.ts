...
export class IconDisruptionComponent extends IconBase {
  constructor() {
...
@NgModule({
  ...
  declarations: [IconDisruptionComponent],
  exports: [IconDisruptionComponent],
})
export class IconDisruptionModule { }
