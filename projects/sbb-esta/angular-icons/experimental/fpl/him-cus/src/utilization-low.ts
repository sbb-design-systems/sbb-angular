...
@Component({
  selector: 'svg[sbbIconUtilizationLow]',
  template: `
    <svg:g fill="none" fill-rule="evenodd">
      ...
      <svg:path
        fill="#BCBCBC"
        d="M9.504 3c.827 0 1.5-.673 1.5-1.5S10.33 0 9.504 0s-1.5.673-1.5 1.5.673 1.5 1.5 1.5M16.508 3c.827 0 1.5-.673 1.5-1.5s-.673-1.5-1.5-1.5-1.5.673-1.5 1.5.673 1.5 1.5 1.5M7.004 10h1v6h3v-6h1V4h-5zM14 4v6h1v6h3v-6h1V4z"
      />
    </svg:g>
  `,
  styles: [
