    ...
    <ng-container [ngSwitch]="size">
      ...
      >
        <g fill="none" fill-rule="evenodd">
          <path
            stroke="#000"
            d="M8.861 17.028L4.126 13.72a1 1 0 0 0-1.252 1.56L8.8 20.5h3.943l1.008 1h7.45l-5.028-5.064c-1.137-1.094-2.584-1.908-4.063-1.936H10c-1.985 0-2.032 3 0 3h2"
          />
          <path
            fill="#000"
      ...
      >
        <g fill="none" fill-rule="evenodd">
          <path
            stroke="#000"
            d="M13.292 25.542L6.189 20.58a1.5 1.5 0 0 0-1.878 2.34l8.888 7.83h5.914l1.512 1.5H31.8l-7.542-7.596c-1.705-1.641-3.876-2.862-6.094-2.904H15c-2.977 0-3.048 4.5 0 4.5h3"
          />
          <path
            fill="#000"
