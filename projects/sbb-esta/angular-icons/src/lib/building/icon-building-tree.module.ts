  ...
  template: `
    ...
    >
      <g fill="none" fill-rule="evenodd" stroke="#000">
        ...
        />
        <path
          d="M11.5 7.5v10.119m31 23.881v-34M21.314 28.087a4.248 4.248 0 0 0-5.861-3.93 4.766 4.766 0 1 0-7.924 3.241 5.308 5.308 0 1 0 7.154 6.898 2.554 2.554 0 0 0 4.375-2.456 4.248 4.248 0 0 0 2.256-3.753z"
        />
      </g>
    </svg>
  `,
