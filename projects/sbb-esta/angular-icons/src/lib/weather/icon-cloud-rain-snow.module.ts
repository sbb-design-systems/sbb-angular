    ...
    <ng-container [ngSwitch]="size">
      ...
      >
        <path
          fill="none"
          stroke="#000"
          d="M7.2 10.2c-.232-1.942 1.88-2.982 3.2-1.9 1.5-3.4 6.4-1.7 5.3 2 2.5-.1 2.536 4.2-.7 4.2H8c-3.367 0-2.94-4.3-.8-4.3zM17.5 17a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zm-4 0a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zm2 3a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zm-9-4l-1 2 1-2zm4 0l-1 2 1-2zm-2 0l-2 4 2-4z"
        />
      </svg>
      <svg
