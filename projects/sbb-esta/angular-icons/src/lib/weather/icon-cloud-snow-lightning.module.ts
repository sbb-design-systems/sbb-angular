    ...
    <ng-container [ngSwitch]="size">
      ...
      >
        <path
          fill="none"
          stroke="#000"
          d="M15 14.5c3.178 0 3.2-4.3.7-4.2 1.1-3.7-3.8-5.4-5.3-2-1.32-1.082-3.432-.042-3.2 1.9-2.141 0-2.567 4.3.8 4.3m5-1L10.5 16h2.169l-3.33 2.715L11 16.5H8.5l3-3H13zm4 3a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zm-2 2a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zm-9-1a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0z"
        />
      </svg>
      <svg
