    ...
    <ng-container [ngSwitch]="size">
      ...
      >
        <g fill="none" fill-rule="evenodd">
          ...
          <path
            fill="#000"
            d="M11.026 16.999v-.838h.88v.838h-.88zm-1.39-4.077c.019-.5.118-.887.297-1.161.166-.252.386-.447.66-.584.275-.137.583-.205.926-.205.551 0 .99.154 1.316.463.304.285.456.66.456 1.124 0 .384-.103.714-.31.992-.092.126-.313.357-.664.696a2.222 2.222 0 0 0-.324.368 1.026 1.026 0 0 0-.128.365 3.193 3.193 0 0 0-.041.565h-.693c.006-.411.042-.717.111-.915.049-.146.118-.276.209-.391.091-.116.293-.331.606-.649.2-.203.332-.387.395-.551.051-.14.077-.283.077-.428 0-.268-.074-.494-.224-.676-.179-.223-.444-.335-.795-.335-.725 0-1.116.441-1.173 1.322h-.701z"
          />
        </g>
      </svg>
      <svg
      ...
      >
        <g fill="none" fill-rule="evenodd">
          ...
          <path
            fill="#000"
            d="M16.539 25.498v-1.257h1.32V25.5h-1.32zm-2.085-6.115c.028-.75.177-1.33.445-1.741.25-.378.58-.671.99-.877a3.069 3.069 0 0 1 1.39-.307c.826 0 1.485.231 1.974.695.456.427.683.99.683 1.686 0 .576-.154 1.07-.465 1.488-.137.188-.469.535-.995 1.043a3.333 3.333 0 0 0-.486.552 1.54 1.54 0 0 0-.192.548c-.041.219-.062.5-.062.848h-1.04c.01-.617.063-1.076.167-1.373.073-.219.177-.414.314-.587.136-.174.439-.496.909-.973.3-.305.498-.58.592-.827.076-.21.116-.424.116-.642 0-.401-.111-.74-.337-1.014-.268-.334-.666-.502-1.192-.502-1.088 0-1.674.662-1.76 1.983h-1.051z"
          />
        </g>
      </svg>
    </ng-container>
