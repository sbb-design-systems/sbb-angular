...
@Component({
  ...
  template: `
    <ng-container [ngSwitch]="size">
      <svg *ngSwitchDefault [attr.class]="'sbb-svg-icon ' + svgClass" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36"><path fill="none" stroke="#000" d="M29.25 16.5V6.75H9.75v13.5l-6 4.5v3H21m-.012-7.5H9.75M21 24.75H3.75m21-6h6c.83 0 1.5.672 1.5 1.5v10.5c0 .83-.67 1.5-1.5 1.5h-6c-.83 0-1.5-.67-1.5-1.5v-10.5c0-.828.67-1.5 1.5-1.5zm.75 1.5H30"/></svg>
