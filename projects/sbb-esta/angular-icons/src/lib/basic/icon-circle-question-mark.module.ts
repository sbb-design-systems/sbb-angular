    ...
    <ng-container [ngSwitch]="size">
      ...
      >
        <g fill="none" fill-rule="evenodd">
          <path
            stroke="#000"
            d="M20.5 12c0 4.712-3.787 8.5-8.5 8.5A8.477 8.477 0 0 1 3.5 12c0-4.713 3.787-8.5 8.5-8.5s8.5 3.787 8.5 8.5z"
          />
          <path
            fill="#000"
            d="M11.124 17.991v-1.666h1.73v1.666h-1.73zM8.393 9.886c.037-.992.232-1.761.585-2.306a3.282 3.282 0 0 1 1.297-1.161c.539-.272 1.145-.408 1.818-.408 1.083 0 1.945.307 2.586.921.597.566.897 1.31.897 2.234 0 .763-.203 1.42-.609 1.97-.181.251-.616.712-1.305 1.385-.305.294-.516.538-.637.733-.12.195-.204.436-.252.725-.053.288-.08.661-.08 1.121h-1.361c.011-.817.083-1.423.216-1.818.096-.289.234-.547.412-.777.179-.229.576-.659 1.189-1.289.396-.406.655-.771.777-1.097a2.47 2.47 0 0 0 .152-.849c0-.534-.146-.982-.44-1.345-.353-.443-.873-.665-1.561-.665-1.426 0-2.195.875-2.306 2.626H8.393z"
          />
        </g>
      </svg>
      <svg
