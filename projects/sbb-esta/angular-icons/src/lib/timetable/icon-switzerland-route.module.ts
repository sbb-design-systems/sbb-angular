    ...
    <ng-container [ngSwitch]="size">
      ...
      >
        <g fill="none" fill-rule="evenodd">
          ...
          <path
            fill="#000"
            d="M9.21 15.75a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm5-5.01a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"
          />
        </g>
      </svg>
      <svg
      ...
      >
        <g fill="none" fill-rule="evenodd">
          ...
          <path
            fill="#000"
            d="M13.815 23.625a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm7.5-7.515a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z"
          />
        </g>
      </svg>
      <svg
