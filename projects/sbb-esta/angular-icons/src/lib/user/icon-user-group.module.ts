...
@Component({
  ...
  template: `
    <ng-container [ngSwitch]="size">
      <svg *ngSwitchDefault [attr.class]="'sbb-svg-icon ' + svgClass" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="none" stroke="#000" d="M13.65 11.746c2.52 1.447 3.64 3.804 3.85 6.755h-11c.05-3.026 1.382-5.358 3.8-6.75m-.77-1.873c.15 1.485 1.156 2.623 2.47 2.623 1.313 0 2.32-1.138 2.47-2.623m-.94-2.756c-.418-.386-.94-.623-1.53-.623-.59 0-1.113.237-1.53.623M16 4.5c-1.313 0-2.319 1.139-2.47 2.623.594.547.97 1.401.97 2.379 0 .129-.018.252-.03.377.418.386.941.623 1.53.623 1.425 0 2.5-1.333 2.5-3 0-1.668-1.075-3.002-2.5-3.002zm-1.53 5.38c.013-.126.03-.249.03-.378 0-.978-.376-1.832-.97-2.379m-3.06 0C10.32 5.638 9.314 4.5 8 4.5c-1.424 0-2.5 1.334-2.5 3.002 0 1.667 1.076 3 2.5 3 .59 0 1.113-.237 1.53-.623-.012-.125-.03-.248-.03-.377 0-.978.377-1.832.97-2.379zm0 0c-.593.547-.97 1.401-.97 2.38 0 .128.018.251.03.376m8.12-.134c2.52 1.447 3.64 3.805 3.85 6.756h-4.312m-10.446-.003H2.5c.05-3.026 1.382-5.358 3.8-6.75"/></svg>
      <svg *ngSwitchCase="size?.indexOf('medium') === 0 ? size : ''" [attr.class]="'sbb-svg-icon ' + svgClass" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36"><path fill="none" stroke="#000" d="M20.476 17.618c3.78 2.17 5.46 5.706 5.775 10.133H9.75c.073-4.54 2.073-8.037 5.698-10.125m-1.154-2.808c.225 2.227 1.734 3.934 3.705 3.934 1.97 0 3.479-1.707 3.704-3.934m-1.409-4.135c-.627-.579-1.411-.934-2.295-.934-.885 0-1.669.355-2.296.934M24 6.75c-1.97 0-3.479 1.708-3.705 3.934.891.82 1.455 2.101 1.455 3.569 0 .193-.027.377-.045.565.627.579 1.412.934 2.295.934 2.137 0 3.75-1.999 3.75-4.5 0-2.502-1.613-4.502-3.75-4.502zm-2.295 8.069c.02-.188.045-.372.045-.566 0-1.467-.564-2.748-1.454-3.568m-4.591 0C15.48 8.456 13.97 6.748 12 6.748c-2.136 0-3.75 2-3.75 4.503 0 2.5 1.614 4.5 3.75 4.5.885 0 1.67-.356 2.296-.935-.02-.187-.046-.372-.046-.565 0-1.467.565-2.748 1.455-3.569zm0 0c-.89.82-1.455 2.1-1.455 3.568 0 .193.027.378.046.565m12.18-.2c3.78 2.17 5.46 5.707 5.775 10.133h-6.468m-15.67-.004H3.75c.075-4.54 2.073-8.037 5.7-10.125"/></svg>
