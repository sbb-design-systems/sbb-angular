  ...
  template: `
    ...
    >
      <g fill="none" fill-rule="evenodd">
        ...
        <path
          fill="#FFF"
          d="M11.288 5.278l-.542.893 1.281.778 1.942-3.197L10.77 1.8l-.78 1.28 1.152.704c-.963.085-1.902.384-2.695 1.307.32.36.616.79.885 1.311.532-.81 1.16-1.058 1.956-1.123M4 9.75H2v1.5h2c.96 0 1.932-.083 2.798-.66a8.972 8.972 0 0 1-.632-1.409c-.586.5-1.283.57-2.166.57"
        />
        <path
          fill="#FFF"
