    ...
    <ng-container [ngSwitch]="size">
      ...
      >
        <g fill="none" fill-rule="evenodd">
          <path
            fill="#000"
            d="M10.832 10.737v2.466h1.665c.575 0 .962-.056 1.161-.168.339-.191.509-.539.509-1.044 0-.568-.229-.948-.686-1.139-.178-.077-.552-.115-1.122-.115h-1.527zm0-2.926V9.99h1.501c.412 0 .715-.03.911-.091a.863.863 0 0 0 .468-.369 1.16 1.16 0 0 0 .175-.637c0-.242-.051-.45-.152-.622a.837.837 0 0 0-.423-.369c-.152-.061-.451-.091-.897-.091h-1.583zm-.833-.804h2.537c.615 0 1.065.078 1.346.234.259.144.464.352.615.625.151.273.227.571.227.893 0 .342-.083.645-.248.91-.166.265-.394.46-.684.584.235.07.418.155.548.254.442.332.664.816.664 1.451 0 .833-.31 1.431-.928 1.796-.29.169-.673.254-1.147.254h-2.93V7.007z"
          />
          <path
            stroke="#000"
            d="M17.5 10.008a5.5 5.5 0 0 0-11 0c.037.943.316 1.736.766 2.485l4.75 7.499 4.75-7.499c.443-.777.726-1.585.734-2.485z"
          />
        </g>
      </svg>
      <svg
      ...
      >
        <g fill="none" fill-rule="evenodd">
          ...
          <path
            stroke="#000"
            d="M26.25 15.012a8.25 8.25 0 0 0-16.5 0c.056 1.415.474 2.604 1.149 3.727l7.125 11.249 7.125-11.248c.665-1.166 1.089-2.378 1.101-3.728z"
          />
        </g>
      </svg>
    </ng-container>
