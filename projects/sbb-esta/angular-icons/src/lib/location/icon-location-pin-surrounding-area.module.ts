    ...
    <ng-container [ngSwitch]="size">
      ...
      >
        <path
          fill="none"
          stroke="#000"
          d="M15.508 8.007a3.5 3.5 0 1 1-7 0 3.5 3.5 0 0 1 7 0zm1.992.008a5.5 5.5 0 0 0-11 0c.037.943.316 1.737.766 2.486l4.75 7.498 4.75-7.498c.443-.777.726-1.585.734-2.486zm-8.698 7.66C5.119 16.092 2.5 17.207 2.5 18.5c0 1.644 4.232 3 9.5 3 5.269 0 9.5-1.356 9.5-3 0-1.283-2.58-2.391-6.218-2.815"
        />
      </svg>
      <svg
