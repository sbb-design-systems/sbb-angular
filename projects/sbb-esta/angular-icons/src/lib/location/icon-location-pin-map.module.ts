    ...
    <ng-container [ngSwitch]="size">
      ...
      >
        <path
          fill="none"
          stroke="#000"
          d="M18.5 9V7.3l-5-2.7-5 4-5-3.6v8.75l5 3.65 5-4 .8.9M8.5 8.6v8.8m5-12.8v8.8m6.997-.212c0-1.485-1.118-2.688-2.497-2.688-1.378 0-2.496 1.204-2.496 2.688.016.461.143.85.347 1.215l2.157 3.665 2.155-3.665c.201-.38.33-.774.334-1.215zM18.5 13a.5.5 0 0 1-.495.5.508.508 0 0 1-.505-.5c0-.273.227-.5.5-.5s.5.227.5.5z"
        />
      </svg>
      <svg
