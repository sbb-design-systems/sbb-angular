    ...
    >
      <g fill="none" fill-rule="evenodd">
        ...
        <path
          fill="#FFF"
          fill-rule="nonzero"
          d="M9.388 4.2h4.042L8.429 15.8H4.37zM26.092 12.366a.922.922 0 0 0 .843-.553L30.216 4.2H16.13l-5.001 11.6h4.025l3.786-8.69h5.973l-1.197 2.775-5.209-.019L22.71 15.8h4.582l-3.113-3.434h1.914z"
        />
      </g>
    </svg>
  `,
